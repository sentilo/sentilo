...
public class DataMessageConverterTest {
	...
	static final String OBSERVATION2 = "28.4";
	static final String OBSERVATION3 = "35.6";
	
	
	DataMessageConverter converter = new DataMessageConverter();

	@Test
	public void marshallMessageWithoutBody() throws MessageNotWritableException{		
		DataInputMessage message = new DataInputMessage(PROVIDER_ID, SENSOR_ID, OBSERVATION); 
	...
	public void marshallMessageWithSensorObservations() throws MessageNotWritableException{		
		...
		String json = converter.marshall(message);				
		String expected = "{\"observations\":[{\"value\":\"23\",\"timestamp\":\"20/02/2013T16:57:17\"},{\"value\":\"28.4\",\"timestamp\":\"20/02/2013T16:55:37\"}],\"location\":\"35.7 56.4\"}";		
		assertNotNull(json);
	...
	public void marshallMessageWithProviderObservations() throws MessageNotWritableException{		
		...
		String json = converter.marshall(message);				
		String expected = "{\"sensors\":[{\"observations\":[{\"value\":\"23\",\"timestamp\":\"20/02/2013T16:57:17\"},{\"value\":\"28.4\",\"timestamp\":\"20/02/2013T16:55:37\"}],\"location\":\"35.7 56.4\",\"sensor\":\"sensor1\"}]}";
		assertNotNull(json);
	...
	private ProviderObservations buildProviderObservations(){
		ProviderObservations provObservations = new ProviderObservations();
		
		SensorObservations sensorObs = buildSensorObservations();
	...
	private SensorObservations buildSensorObservations(){
		SensorObservations sensorObs = new SensorObservations();
