...
public class RequestUtilsTest {
	...
	public void buildOrderPath(){		
		OrderInputMessage message = new OrderInputMessage(PROVIDER_ID, SENSOR_ID, new OrderMessage(ORDER));
	...
	public void buildGlobalOrderPath(){		
		OrderInputMessage message = new OrderInputMessage(PROVIDER_ID,new OrderMessage(ORDER));
		String path = RequestUtils.buildPath(message);
	...
	public void buildDataParameters(){		
		...
		String toText = DateUtils.toStringTimestamp(to);
		String fromText = DateUtils.toStringTimestamp(from);
