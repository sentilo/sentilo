...
@Suite.SuiteClasses({ 
  ...
  SubscribeInputMessageTest.class,
  SubscribeMessageConverterTest.class,
  AlarmMessageConverterTest.class,
  OrderMessageConverterTest.class,
  DataMessageConverterTest.class,
  CatalogMessageConverterTest.class}
)
