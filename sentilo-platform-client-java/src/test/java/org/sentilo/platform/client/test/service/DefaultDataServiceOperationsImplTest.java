...
public class DefaultDataServiceOperationsImplTest {
  ...
  @InjectMocks
  private DefaultDataServiceOperationsImpl service;

  @Mock
  private RESTClient restClient;

  @Mock
  private DataInputMessage message;
  ...
  @Test
  public void getLastObservations() {
    service.getLastObservations(message);

    verify(restClient).get(any(RequestContext.class));
    verify(converter).unmarshal(any(String.class), eq(ObservationsOutputMessage.class));
  }

  @Test
  public void removeLastObservations() {
    service.removeLastObservations(message);
  ...
  public void sendObservations() {
    service.sendObservations(message);
