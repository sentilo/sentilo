...
public class CatalogAlertMessageConverter extends BaseJsonMessageConverter {

  public String marshall(final PlatformClientInputMessage message) throws MessageNotWritableException {
    return writeInternalAndReturnString(message);
  }

  public CatalogAlertOutputMessage unmarshall(final String message) throws MessageNotReadableException {
    return (CatalogAlertOutputMessage) readInternal(CatalogAlertOutputMessage.class, message);
  }
}
