...
public class PlatformClientExceptionTranslator implements PlatformExceptionTranslator {
  ...
  private final Logger logger = LoggerFactory.getLogger(PlatformClientExceptionTranslator.class);

  @Override
  public PlatformAccessException translateExceptionIfPossible(final RuntimeException ex) {
