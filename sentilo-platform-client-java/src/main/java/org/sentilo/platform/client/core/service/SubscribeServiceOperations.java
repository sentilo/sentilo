...
public interface SubscribeServiceOperations {

  void remove(SubscribeInputMessage message);

  SubscriptionsOutputMessage get(SubscribeInputMessage message);

  void subscribe(SubscribeInputMessage message);
}
