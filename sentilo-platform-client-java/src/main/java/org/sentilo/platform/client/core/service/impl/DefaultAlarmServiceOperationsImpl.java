...
public class DefaultAlarmServiceOperationsImpl extends AbstractServiceOperationsImpl implements AlarmServiceOperations {
	...
	/*
	 * (non-Javadoc)
	 * @see org.sentilo.platform.client.core.service.AlarmServiceOperations#publish(org.sentilo.platform.client.core.domain.AlarmInputMessage)
	 */
	public void publish(AlarmInputMessage message){						
	...
	/*
	 * (non-Javadoc)
	 * @see org.sentilo.platform.client.core.service.AlarmServiceOperations#getLastAlarmMessages(org.sentilo.platform.client.core.domain.AlarmInputMessage)
	 */
	public AlarmsOutputMessage getLastAlarmMessages(AlarmInputMessage message) {
		logger.debug("Retrieving last alarm messages  {}", message);
		String response = restClient.get(RequestUtils.buildPath(message), RequestUtils.buildParameters(message), message.getIdentityToken());
