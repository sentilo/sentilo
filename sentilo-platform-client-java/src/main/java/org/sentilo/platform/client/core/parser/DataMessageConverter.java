...
public class DataMessageConverter extends BaseJsonMessageConverter {
	...
	public String marshall(DataInputMessage message) throws MessageNotWritableException{
	...
	public ObservationsOutputMessage unmarshall(String message) throws MessageNotReadableException{
