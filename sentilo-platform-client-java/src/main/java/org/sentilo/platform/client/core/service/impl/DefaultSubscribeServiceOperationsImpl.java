...
public class DefaultSubscribeServiceOperationsImpl extends AbstractServiceOperationsImpl implements SubscribeServiceOperations {
	...
	@Override
	public void remove(SubscribeInputMessage message){		
	...
	@Override
	public SubscriptionsOutputMessage get(SubscribeInputMessage message){
		logger.debug("Retrieving subscriptions {}", message);
		String response = restClient.get(RequestUtils.buildPath(message), message.getIdentityToken());
	...
	@Override
	public void subscribe(SubscribeInputMessage message){		
