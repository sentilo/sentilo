...
public class AlarmMessageConverter extends BaseJsonMessageConverter {
	...
	public String marshall(AlarmInputMessage message) throws MessageNotWritableException{
		return writeInternalAndReturnString(message.getMessage());
	}
	
	public AlarmsOutputMessage unmarshall(String message) throws MessageNotReadableException{
