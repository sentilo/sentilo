...
public class CatalogMessageConverter extends BaseJsonMessageConverter {
	...
	public String marshall(PlatformClientInputMessage message) throws MessageNotWritableException{
		return writeInternalAndReturnString(message);
	}		
	
	public CatalogOutputMessage unmarshall(String message) throws MessageNotReadableException{
