...
public class CatalogMessageConverter extends BaseJsonMessageConverter {
  ...
  public CatalogOutputMessage unmarshall(final String message) throws MessageNotReadableException {
    return (CatalogOutputMessage) readInternal(CatalogOutputMessage.class, message);
  }
}
