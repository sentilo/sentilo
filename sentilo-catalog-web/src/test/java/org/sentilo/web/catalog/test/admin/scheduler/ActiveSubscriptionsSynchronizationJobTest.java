...
import org.sentilo.web.catalog.admin.scheduler.ActiveSubscriptionsSynchronizationJob;
...
public class ActiveSubscriptionsSynchronizationJobTest {
  ...
  public void syncActiveSubscriptionsTest1() {
    ...
    verify(activeSubscriptionsService).insertAll(anyListOf(ActiveSubscription.class));
  }
