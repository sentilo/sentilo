...
public class CatalogUtilsTest {
  ...
  public void tagsToStringListNull() {
    final String tags_1 = null;
    final String tags_2 = "";
    final List<String> result_1 = CatalogUtils.tagsToStringList(tags_1);
    final List<String> result_2 = CatalogUtils.tagsToStringList(tags_2);
    Assert.assertNull(result_1);
