...
public class SensorTypeServiceImplTest {
  ...
  public void getComponentsTypeFromProvider() {
    ...
    when(mongoOps.getCollectionName(any(Class.class))).thenReturn(sensorCollectionName);
    ...
    when(mongoOps.find(any(Query.class), any(Class.class))).thenReturn(expectedSensorTypesList);
