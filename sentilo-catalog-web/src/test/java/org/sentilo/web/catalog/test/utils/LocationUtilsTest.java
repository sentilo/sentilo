...
public class LocationUtilsTest {
  ...
  @Test
  public void parse_wrong_coordinates() {
    final String coordinates = "2.1234541.123456";

    final Location location = LocationUtils.parse(coordinates);
  ...
  @Test
  public void parse_polygon_coordinates() {
  ...
  public void to_string() {
    ...
    Assert.assertEquals(coordinates, LocationUtils.toString(location));
  }
}
