...
import org.sentilo.web.catalog.metrics.CatalogMetricsCounter;
...
public class MetricsInterceptorTest {
  ...
  @Mock
  private CatalogMetricsCounter catalogRequestsCounter;
  ...
  public void preHandle() throws Exception {
    ...
    verify(catalogRequestsCounter).incrementTotalRequests();
  }
  ...
  public void postHandle() throws Exception {
    ...
    verify(catalogRequestsCounter).incrementStatusRequests(HttpStatus.OK.value());
  }
}
