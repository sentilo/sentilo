...
public class CompoundKeyBuilderTest {
  ...
  public void buildKeyWithTwoTokens() {
    ...
    final String compoundKey = CompoundKeyBuilder.buildCompoundKey(token1, token2);
    final String expectedValue = token1.concat(Constants.DEFAULT_KEY_TOKEN_SPLITTER).concat(token2);
