...
public class AlertRuleServiceImplTest extends AbstractBaseTest {
  ...
  @Mock
  @Autowired
  protected PublishSignalService signalService;
  ...
  public void createAlerts() throws Exception {
    ...
    if (filteredSensorsList.size() > 0) {
      verify(signalService).publishInternalSignal(SignalType.RELOAD_ALERTS, Constants.MODULE_NAME);
    }
  }
