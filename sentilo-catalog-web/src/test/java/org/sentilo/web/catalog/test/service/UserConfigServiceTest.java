...
public class UserConfigServiceTest {
  ...
  private final static Integer INSTANCE_CHART_NUM_OBS = 15;
  ...
  private final static Integer DEFAULT_CHART_NUM_OBS = Constants.DEFAULT_CHART_OBS_NUMBER;
  ...
  public void setUp() {
    ...
    when(catalogProperties.getProperty(eq("catalog.default.timezone"), any(String.class))).thenReturn(INSTANCE_TIME_ZONE);
    when(catalogProperties.getProperty(eq("catalog.default.datePattern"), any(String.class))).thenReturn(INSTANCE_DATE_FORMAT_PATTERN);
    when(catalogProperties.getProperty(eq("catalog.default.chart.numObs"), any(String.class))).thenReturn(String.valueOf(INSTANCE_CHART_NUM_OBS));
    ...
    currentUser.getVisualConfiguration().setChartVisibleObservationsNumber(USER_CHART_NUM_OBS);
  ...
  @Test
  public void refreshCatalogUserConfigContextObsNumberFromConstats() {

    // Test that there is an exception getting DEFAULT_CHART_NUM_OBS from properties

    UserConfigContextHolder.clearContext();
    when(catalogProperties.getProperty(eq("catalog.default.chart.numObs"), eq(String.valueOf(DEFAULT_CHART_NUM_OBS)))).thenReturn(null);
    ...
    Assert.assertEquals(DEFAULT_CHART_NUM_OBS, context.getUserChartNumObs());
  }

  @Test
  public void refreshCatalogUserConfigContextNoAthentication1() {

    // Test that there isn't authentication context, and no tenant, so get data from instance
  ...
  @Test
  public void refreshCatalogUserConfigContextNoAthentication2() {
    ...
    final String catalogUserDetails = "ningu";
  ...
  public void getUserConfigNoUserNoTenantNoInstanceFromDefaultTest() {
    ...
    UserConfigContextHolder.clearContext();
    when(catalogProperties.getProperty(eq("catalog.default.timezone"), eq(DEFAULT_TIME_ZONE))).thenReturn(DEFAULT_TIME_ZONE);
    when(catalogProperties.getProperty(eq("catalog.default.datePattern"), eq(DEFAULT_DATE_FORMAT_PATTERN))).thenReturn(DEFAULT_DATE_FORMAT_PATTERN);
    when(catalogProperties.getProperty(eq("catalog.default.chart.numObs"), eq(String.valueOf(DEFAULT_CHART_NUM_OBS))))
        .thenReturn(String.valueOf(DEFAULT_CHART_NUM_OBS));
  ...
  public void getUserConfigNoUserNoTenantFromInstanceTest() {
    ...
    Assert.assertEquals(INSTANCE_DATE_FORMAT_PATTERN, context.getUserDatePattern());
    Assert.assertEquals(INSTANCE_TIME_ZONE, context.getUserTimeZone().getID());
    Assert.assertEquals(INSTANCE_CHART_NUM_OBS, context.getUserChartNumObs());
  }
  ...
  public void getUserConfigNoUserFromTenantTest() {
    ...
    UserConfigContextHolder.clearContext();
    when(tenantVisualConfiguration.getChartVisibleObservationsNumber()).thenReturn(TENANT_CHART_NUM_OBS);
    ...
    Assert.assertEquals(TENANT_CHART_NUM_OBS, context.getUserChartNumObs());
  }
  ...
  public void getUserConfigFromUserFromTest() {
    ...
    Assert.assertEquals(currentUser.getVisualConfiguration().getChartVisibleObservationsNumber(), context.getUserChartNumObs());
  }

  @Test
  public void setDefaultCatalogUserConfigContextTest() {
    userConfigService.setDefaultCatalogUserConfigContext();
    final UserConfigContext context = UserConfigContextHolder.getContext();
    Assert.assertNotNull(context);
    Assert.assertEquals(context.getUserDatePattern(), INSTANCE_DATE_FORMAT_PATTERN);
    Assert.assertEquals(context.getUserChartNumObs(), INSTANCE_CHART_NUM_OBS);
    Assert.assertEquals(context.getUserTimeZone(), TimeZone.getTimeZone(INSTANCE_TIME_ZONE));
  }

  @Test
  public void setDefaultCatalogUserConfigContextNumObsNumberFormatExceptionTest() {
    when(catalogProperties.getProperty(eq("catalog.default.chart.numObs"), eq(String.valueOf(DEFAULT_CHART_NUM_OBS)))).thenReturn(null);
    userConfigService.setDefaultCatalogUserConfigContext();
    final UserConfigContext context = UserConfigContextHolder.getContext();
    Assert.assertNotNull(context);
    Assert.assertEquals(context.getUserDatePattern(), INSTANCE_DATE_FORMAT_PATTERN);
    Assert.assertEquals(context.getUserChartNumObs(), DEFAULT_CHART_NUM_OBS);
    Assert.assertEquals(context.getUserTimeZone(), TimeZone.getTimeZone(INSTANCE_TIME_ZONE));
  }
