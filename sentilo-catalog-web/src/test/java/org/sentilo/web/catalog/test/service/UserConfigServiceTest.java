...
public class UserConfigServiceTest {
  ...
  public void setUp() {
    ...
    when(configService.getConfigValue(eq("sentilo.catalog.default.timezone"), any(String.class))).thenReturn(INSTANCE_TIME_ZONE);
    when(configService.getConfigValue(eq("sentilo.catalog.default.datePattern"), any(String.class))).thenReturn(INSTANCE_DATE_FORMAT_PATTERN);
    when(configService.getConfigValue(eq("sentilo.catalog.default.chart.numPoints"), eq(Integer.class), any(Integer.class)))
  ...
  public void refreshCatalogUserConfigContextWithDefaultValues() {
    ...
    UserConfigContextHolder.clearContext();
    when(configService.getConfigValue("sentilo.catalog.default.chart.numPoints", Integer.class, DEFAULT_CHART_NUM_OBS))
        .thenReturn(DEFAULT_CHART_NUM_OBS);
  ...
  public void getUserConfigNoUserNoTenantNoInstanceFromDefaultTest() {
    ...
    UserConfigContextHolder.clearContext();
    when(configService.getConfigValue("sentilo.catalog.default.timezone", DEFAULT_TIME_ZONE)).thenReturn(DEFAULT_TIME_ZONE);
    when(configService.getConfigValue("sentilo.catalog.default.datePattern", DEFAULT_DATE_FORMAT_PATTERN)).thenReturn(DEFAULT_DATE_FORMAT_PATTERN);
    when(configService.getConfigValue("sentilo.catalog.default.chart.numPoints", Integer.class, DEFAULT_CHART_NUM_OBS))
        .thenReturn(DEFAULT_CHART_NUM_OBS);
