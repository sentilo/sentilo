...
<div class="span12">
	...
	<h1 class="lead">
		...
		<small><spring:message code="stats.title"/></small>
	</h1>
	...
	<div class="row-fluid">
		<div class="span3">
			...
			<div class="accordion-group">
				<div class="accordion-heading">
					<a class="accordion-toggle" data-toggle="collapse" data-parent="#devicesAccordion" href="#devicesAccordionCollapse">
						<i class="icon-map-marker"></i>
						<spring:message code="stats.devices" />
		...
		<div class="span3">
			...
			<div class="accordion-group">
				<div class="accordion-heading">
					<a class="accordion-toggle" data-toggle="collapse" data-parent="#eventsAccordion" href="#eventsAccordionCollapse">
						<i class="icon-upload"></i>
						<spring:message code="stats.events" />
						<i class="icon-chevron-down pull-right"></i>
					</a>
				</div>
		...
		<div class="span3">
			...
			<div class="accordion-group">
				<div class="accordion-heading">
					<a class="accordion-toggle" data-toggle="collapse" data-parent="#performanceAccordion" href="#performanceAccordionCollapse">
						<i class="icon-time"></i>
						<spring:message code="stats.performance" />
						<i class="icon-chevron-down pull-right"></i>
					</a>
				</div>
		...
		<div class="span3">
			...
			<div class="accordion-group">
				<div class="accordion-heading">
					<a class="accordion-toggle" data-toggle="collapse" data-parent="#accountsAccordion" href="#accountsAccordionCollapse">
						<i class="icon-user"></i>
						<spring:message code="stats.accounts" />
						<i class="icon-chevron-down pull-right"></i>
					</a>
				</div>
	...
	<div class="row-fluid">
		<div class="span12">
			...
			<div class="accordion-group">
				<div class="accordion-heading">
					<a class="accordion-toggle" data-toggle="collapse" data-parent="#activityAccordion" href="#activityAccordionCollapse">
						<i class="icon-signal"></i>
						<spring:message code="stats.activity" />
						<i class="icon-chevron-down pull-right"></i>
					</a>
				</div>
