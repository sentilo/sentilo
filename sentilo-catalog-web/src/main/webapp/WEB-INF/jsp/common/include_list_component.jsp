...
<div class="control-group pull-right">
	...
	<a href="#" onclick="deleteSelected('components');" class="btn btn-danger"> <spring:message
			code="component.unassign.title" /> </a> <a href="#" onclick="window.location.href='${addComponentsURL}';" class="btn">
		<spring:message code="component.assign.title" /> </a>
</div>
