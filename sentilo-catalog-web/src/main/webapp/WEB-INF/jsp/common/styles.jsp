...
<spring:url value="/static/css/slick/slick.css" var="slickCarouselCSS" />
<spring:url value="/static/css/slick/slick-theme.css" var="slickCarouselThemeCSS" />
...
<spring:url value="/static/css/DT_scroller.css" var="dataTableScrollerCSS" />
<spring:url value="/static/css/sector-custom-popup.css" var="sectorCustomPopupCSS" />
<spring:url value="/static/css/bootstrap2-toggle.min.css" var="bootstrapToggleCSS" />
...
<link href="${dataTableScrollerCSS}" rel="stylesheet" media="all">
<link href="${sectorCustomPopupCSS}" rel="stylesheet" media="all">
<link href="${bootstrapToggleCSS}" rel="stylesheet" media="all">
...
<c:if test="${not empty currentRequestMapping}">
	<c:choose>
		<c:when test="${fn:contains(currentRequestMapping, '/component/map')}">
			...
			<link href="${slickCarouselCSS}" rel="stylesheet" media="all">
			<link href="${slickCarouselThemeCSS}" rel="stylesheet" media="all">
		</c:when>
	</c:choose>
</c:if>
