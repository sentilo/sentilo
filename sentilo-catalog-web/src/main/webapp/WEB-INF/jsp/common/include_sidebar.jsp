...
<spring:url value="/admin/alarm/list" var="alarmListURL" />
...
<c:set value=" connecta-icon-black" var="classAlarmIcon"/>
...
<c:if test="${activeMenu == '/alarm' }">			
	<c:set value=" class='current'" var="classAlarm"/>
	<c:set value=" icon-white" var="classAlarmIcon"/>
</c:if>
...
<div id="menu-left" class="sidebar-nav">
	<ul class="nav nav-list">
		<security:authorize access="hasRole('ROLE_ADMIN')">
			...
			<li>
				<a href="${alarmListURL}" ${classAlarm}>
					<i class="icon-bell-alt${classAlarmIcon}"></i>
					<spring:message code="sidebar.alarm.title" />
				</a>
			</li>
			<li>
