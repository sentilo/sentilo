...
<div class="control-group">
	<label for="geodeticSystem" class="control-label"> <spring:message code="component.geodeticSystem" /> </label>
	<div class="controls">
		<form:select path="geodeticSystem">
			<form:option value="">${emptySelectMessage}</form:option>
			<form:options items="${geodeticSystem}" itemValue="value" itemLabel="label" />
		</form:select>
		<form:errors path="geodeticSystem" cssClass="text-error" htmlEscape="false" />
	</div>
</div>
...
<div class="control-group">
	...
	<div class="controls">
		<input type="text" id="txtlatitude" maxlength="17"/>
	</div>	
</div>
...
<div class="control-group">
	...
	<div class="controls">
		<input type="text" id="txtlongitude" maxlength="17"/>
	</div>	
</div>
...
<div class="control-group">
    ...
    <div class="controls">
    	...
    	<form:hidden path="location.fromTsTime" />
