...
<script>
    ...
    /**
	 * If location coordinates have changed, then unset field location.fromTsTime and set location field with the new coordinates     
     */
    function updateLocationHiddenFields(currentLocation){
    	let oldLocation = $('#location').val();
		if(currentLocation != oldLocation){
		   $('#location\\.fromTsTime').val('');
