...
<spring:message code="provider.active.tooltip" var="providerActiveTooltip" />
...
<c:if test="${mode == 'edit' }">
	...
	<spring:url  value="/admin/provider/regenerate/token" var="regenerateTokenUrl" />
	<spring:message code="token.regeneration.provider.confirm.message" var="confirmTokenMessage" />
</c:if>
					...
					<c:if test="${showSectorsTab}">
						<div class="tabbable">
							<ul class="nav nav-tabs">
								<li class="active"><a href="#tab1" data-toggle="tab"><spring:message code="provider.new.tab.title" /></a></li>
					...
					<fieldset>
						...
						<div class="control-group">
							<form:label path="active" class="control-label">
								<spring:message code="provider.active" />
							</form:label>
							<div class="controls">
								<form:checkbox path="active" tooltip="${providerActiveTooltip}" />
					...
					<fieldset>
						...
						<div class="control-group">
							<div class="controls">
								...
								<a href="#" <c:if test="${not showSectorsTab}">onclick="$('form#provider').submit();"</c:if> class="btn btn-success">
