...
<div class="span12">
	...
	<h1 class="lead">
		<spring:message code="provider.list.title"/><br/>
	</h1>

	<form:form method="post"  onkeypress="return preventEnterSubmit(event);" modelAttribute="providers" action="${deleteURL}">
		...
		<div class="control-group pull-right">
			<a href="#" onclick="deleteSelected('providers','${deleteProviderConfirmMessage}');" class="btn btn-danger">
				<spring:message code="provider.delete.title"/>
			</a>
			<a href="#" onclick="window.location.href='${newProviderLink}';" class="btn">
				<spring:message code="provider.new.title" />
			</a>	
		</div>
