...
<spring:message  code="provider.delete.confirmation.message" var="deleteSelectedMessage" />
						...
						<form:form method="post" onkeypress="return preventEnterSubmit(event);" modelAttribute="providers"
							...
							<c:if test="${showAdminControls}">
								<div class="control-group pull-right">
									<a href="#" onclick='deleteSelected("providers","${deleteSelectedMessage}");' class="btn btn-danger">
