...
<spring:message code="tenant.displayName.tooltip" var="displayNameTooltip"/>
						...
						<form:form method="post" modelAttribute="tenant" action="${actionURL}" class="form-horizontal" autocomplete="off">
									...
									<div class="tab-pane active" id="tab1">
										...
										<div class="control-group">
											<form:label path="displayName" class="control-label">
												<spring:message code="tenant.displayName" />
											</form:label>
											<div class="controls">
												<form:input path="displayName" tooltip="${displayNameTooltip}"/>
										...
										<div class="control-group">
											<form:label path="address" class="control-label">
												<spring:message code="tenant.address" />
											</form:label>
											<div class="controls">
												<form:input path="address" />
												<form:errors path="address" cssClass="text-error" htmlEscape="false" />
											</div>
										</div>
										<div class="control-group">
											<form:label path="logoUrl" class="control-label">
												<spring:message code="tenant.logoUrl" />
											</form:label>
											<div class="controls">
												<form:input path="logoUrl"/>
												<form:errors path="logoUrl" cssClass="text-error" htmlEscape="false" />
											</div>
										</div>
										<div class="control-group">
							...
							<div class="control-group">
								<div class="controls">
									...
									<a href="#" onclick="$('form#tenant').submit();" class="btn btn-success"> 
