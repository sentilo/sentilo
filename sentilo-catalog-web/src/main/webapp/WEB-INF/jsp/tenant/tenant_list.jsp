...
<spring:message  code="tenant.delete.confirmation.message" var="deleteSelectedMessage" />
					...
					<div class="span12">
						...
						<form:form method="post" onkeypress="return preventEnterSubmit(event);" modelAttribute="tenants" action="${deleteURL}">
							...
							<div class="control-group pull-right">
								<a href="#" onclick='deleteSelected("tenants", "${deleteSelectedMessage}");' class="btn btn-danger"> 
