							...
							<div class="tabbable">
								<ul class="nav nav-tabs">
									...
									<c:if test="${showSectorsTab}">
										<li><a href="#tab3" data-toggle="tab"><spring:message code="sector.new.resource.title" /></a></li>
									</c:if>
								</ul>
								<div class="tab-content">
										...
										<div class="control-group">
											...
											<div class="controls">
												...
												<c:if test="${mode == 'edit' }">
													...
													<a href="#" onclick="showChangePasswordModalWindow();" class="btn btn-primary"> <spring:message code="user.edit.password" /> </a>
										...
										<div class="control-group">
											<div class="controls">
												...
												<c:if test="${showAdminControls or mode == 'edit'}">
													<a href="#" <c:if test="${not showSectorsTab}">onclick="$('form#user').submit();"</c:if> class="btn btn-success"> <spring:message code="button.save" /> </a>
												</c:if>
											</div>
										</div>										
									</div>
									...
									<c:if test="${showSectorsTab}">
										<div class="tab-pane" id="tab3">
											<c:set var="showGrantColumn" value="false" scope="request" />
