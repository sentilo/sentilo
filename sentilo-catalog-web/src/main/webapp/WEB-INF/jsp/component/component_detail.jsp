					...
					<div class="row-fluid">
						...
						<div class="tabbable">
							<ul class="nav nav-tabs">
								...
								<li class="${tab3Class}"><a href="#tab3" data-toggle="tab"><spring:message code="additionalInfo.tab.label" /></a></li>
										...
										<div class="accordion-group">
											...
											<div id="detailAccordionCollapse" class="accordion-body collapse in">
												<div class="accordion-inner">
												    <div class="row-fluid">
														<div class="span4">
															<strong><spring:message code="component.displayName" /> </strong>
														</div>
														<div class="span8">${component.friendlyName}</div>
													</div>
													<div class="row-fluid">
														<div class="span4">
													...
													<div class="row-fluid">
														...
														<div class="row-fluid">
															<div class="span4">
																<strong><spring:message code="component.geodeticSystem" /> </strong>
															</div>
															<div class="span8">
																<span class="label label-info">${component.geodeticSystem}</span>
															</div>
														</div>
														<div class="row-fluid">
															<div class="span4">
																<strong><spring:message code="component.photoUrl" /> </strong>
															</div>
															<div class="span8">${component.photoUrl}</div>
														</div>
														<div class="row-fluid">
															<div class="span4">
																<strong><spring:message code="component.extendedDetailUrl" /> </strong>
															</div>
															<div class="span8">${component.extendedDetailUrl}</div>
														</div>
													</div>
													<c:if test="${not empty sectors}">
														<div class="row-fluid">
															<div class="span4">
																<strong><spring:message code="sector.new.resource.title" /></strong>
															</div>				
															<div class="span8">
