...
<div class="row-fluid">
	...
	<h1 class="lead">
		${component.name}<br/>
		<small><spring:message code="id"/> ${component.id}</small>
	</h1>

    <div class="tabbable">
   		<ul class="nav nav-tabs">
		    <li class="${tab1Class}"><a href="#tab1" data-toggle="tab"><spring:message code="component.detail.title" /></a></li>
		    <li class="${tab2Class}"><a href="#tab2" data-toggle="tab"><spring:message code="component.components" /></a></li>
		    <li class="${tab3Class}"><a href="#tab3" data-toggle="tab"><spring:message code="sensor.list.title" /></a></li>
   		</ul>
				...
				<div class="accordion-group">
					...
					<div id="detailAccordionCollapse" class="accordion-body collapse in">
						<div class="accordion-inner">
							<div class="row-fluid">
								<div class="span4"><strong><spring:message code="component.type" /></strong></div>
								<div class="span8"><span class="label">${component.componentType}</span></div>
							</div>
							<div class="row-fluid">
								<div class="span4"><strong><spring:message code="component.description" /></strong></div>
								<div class="span8">${component.description}</div>
							</div>
							<div class="row-fluid">
								<div class="span4"><strong><spring:message code="component.providerId" /></strong></div>
								<div class="span8">${component.providerId}</div>
							</div>
							<div class="row-fluid">
								<div class="span4"><strong><spring:message code="component.accessType" /></strong></div>
								<div class="span8">
							...
							<div class="row-fluid">
								<div class="span4"><strong><spring:message code="component.createdAt" /></strong></div>
								<div class="span8"><spring:eval expression="component.createdAt"/></div>
							</div>
							<div class="row-fluid">
								<div class="span4"><strong><spring:message code="component.updatedAt" /></strong></div>
								<div class="span8"><spring:eval expression="component.updateAt"/></div>
							</div>
							<c:set value="${component.tagsAsList}" var="tags" scope="request"/>
							<%@include file="/WEB-INF/jsp/common/include_detail_tags.jsp" %>
							<div class="row-fluid">
								<div class="span4"><strong><spring:message code="component.location" /></strong></div>
								<div class="span8">
									<span class="label">
