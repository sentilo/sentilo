...
<spring:message code="component.extendedDetailUrl.tooltip" var="extendedDetailUrlTooltip"/>
<spring:message code="component.photoUrl.tooltip" var="photoUrlTooltip"/>
					...
					<fieldset>
						<div class="tabbable">
							<ul class="nav nav-tabs">
								...
								<li><a href="#tab3" data-toggle="tab"><spring:message code="additionalInfo.tab.label" /></a></li>
							</ul>
							<c:if test="${editMode}">
								<form:hidden path="id" />
							...
							<div class="tab-content">
								<div class="tab-pane active" id="tab1">
									...
									<div class="control-group">
										<form:label path="displayName" class="control-label">
											<spring:message code="component.displayName" />
										</form:label>
										<div class="controls">
											<form:input path="displayName" />
											<form:errors path="displayName" cssClass="text-error" htmlEscape="false" />
										</div>
									</div>
									<div class="control-group">
									...
									<div class="control-group">
										<form:label path="photoUrl" class="control-label">
											<spring:message code="component.photoUrl" />
										</form:label>
										<div class="controls">
											<form:input path="photoUrl" tooltip="${photoUrlTooltip}"/>
											<form:errors path="photoUrl" cssClass="text-error" htmlEscape="false" />
										</div>
									</div>
									<div class="control-group">
										<form:label path="extendedDetailUrl" class="control-label">
											<spring:message code="component.extendedDetailUrl" />
										</form:label>
										<div class="controls">
											<form:input path="extendedDetailUrl" tooltip="${extendedDetailUrlTooltip}" />
											<form:errors path="extendedDetailUrl" cssClass="text-error" htmlEscape="false" />
										</div>
									</div>
									<div class="control-group">
