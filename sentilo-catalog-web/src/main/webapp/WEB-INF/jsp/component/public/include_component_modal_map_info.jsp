...
<spring:eval var="showFooterLegal" expression="@sentiloConfigProperties.getProperty('sentilo.catalog.show.footer_legal')"/>
...
<div id="component-detail-modal-info-window" style="display: none;">
    ...
    <div id="component-sections">
        <ul class="nav nav-pills">
            ...
            <li><a href="#" onclick="$('#componentSeeMoreLink').show(); hideModalLayer(); return false;"><i class="icon-chevron-down icon-close-infowindow"></i></a></li>
        </ul>
    </div>
                ...
                <div class="component-footer">
                    <div class="row-fluid">
                        <c:if test="${showFooterLegal eq 'true'}">
                            <p><spring:message code="footer.legal" /></p>
                        </c:if>
                        <p><spring:message code="footer.copy" htmlEscape="false"/></p>
                    </div>
                </div>
                ...
                <div class="row-fluid">
                    <div class="span12">
                        <div class="tab-content">
                            ...
                            <div class="carousel" id="sensors-list-tabs" style="display: none"></div>
