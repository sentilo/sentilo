...
<div class="span12">
	...
	<div class="pull-right">
		...
		<a href="${publicMapURL}<c:if test="${alternative eq 'true'}">?alternative=true</c:if>" class="btn btn-danger"><i class="icon-remove icon-white"></i> Close</a>
	</div>
	<br/>
	<div class="">
		...
		<div class="pull-right"><span id="detailComponentId"><spring:message code="id"/> ${component.id}</span></div>
	</div>
</div>
</div>
