...
<div class="accordion-group">
	<div class="accordion-heading">
		<a class="accordion-toggle" data-toggle="collapse" data-parent="#photoAccordion" href="#photoAccordionCollapse">
			...
			<spring:message code="component.images" />
			<i class="icon-chevron-down pull-right"></i>
		</a>
	</div>
	<div id="photoAccordionCollapse" class="accordion-body collapse <c:if test="${alternative ne 'true' or not empty testPage}">in</c:if>">
