			...
			<div class="accordion-toggle in">
				...
				<div class="pull-right">
					<ul class="nav nav-pills">
						...
						<li>
							<a href="#alarms" onclick="changeDataType('alarms');" data-toggle="pill"><spring:message code="component.alarms"/></a>
						</li>
						<li>
							<a href="#orders" onclick="changeDataType('orders');" data-toggle="pill"><spring:message code="component.orders"/></a>
						</li>
					</ul>
				...
				<div class="accordion-inner accordion-tall">
					...
					<div class="tab-content">
						<div class="tab-pane active" id="activity">
							<div id="activity_placeholder" style="width: 100%; height: 150px; margin: 0 auto; padding: 0px; position: relative; overflow-y:auto;">
							</div>
						</div>
						<div class="tab-pane" id="alarms" style="overflow-y:auto;">
							<div id="alarms_placeholder" style="width: 100%; height: 150px; margin: 0 auto; padding: 0px; position: relative; overflow-y:auto;">
							</div>
						</div>
						<div class="tab-pane" id="orders" style="overflow-y:auto;">
							<div id="orders_placeholder" style="width: 100%; height: 150px; margin: 0 auto; padding: 0px; position: relative; overflow-y:auto;">
							</div>
						</div>
					</div>
				</div>
