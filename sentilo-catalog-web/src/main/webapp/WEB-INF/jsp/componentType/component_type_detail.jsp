										...
										<div class="accordion-group">
											...
											<div id="detailAccordionCollapse" class="accordion-body collapse in">
												<div class="accordion-inner">
													...
													<div class="row-fluid">
														<div class="span4">
															<strong><spring:message code="componenttype.photoUrl" /> </strong>
														</div>
														<div class="span8">${componentType.photoUrl}</div>
													</div>
													<div class="row-fluid">
														<div class="span4">
															<strong><spring:message code="componenttype.extendedDetailUrl" /> </strong>
														</div>
														<div class="span8">${componentType.extendedDetailUrl}</div>
													</div>
													<c:set value="${componentType.tagsAsList}" var="tags" scope="request" />
