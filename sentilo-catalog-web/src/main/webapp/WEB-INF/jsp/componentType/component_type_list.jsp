					...
					<div class="span12">
						...
						<form:form method="post" onkeypress="return preventEnterSubmit(event);" modelAttribute="componentTypes"
							...
							<div class="control-group pull-right">
								<a href="#" onclick="deleteSelected('componentTypes');" class="btn btn-danger"> <spring:message
										code="componenttype.delete.title" /> </a> <a href="#" type="button"
									onclick="window.location.href='${newComponentTypeURL}';" class="btn"> <spring:message
										code="componenttype.new.title" /> </a>
							</div>
						</form:form>
					</div>
				</div>
