...
<c:choose>
	<c:when test="${multitenantIsEnabled}">
		<spring:message code="componenttype.extendedDetailUrl.multitenant.tooltip" var="extendedDetailUrlTooltip"/>
    	<spring:message code="componenttype.photoUrl.multitenant.tooltip" var="photoUrlTooltip"/>
	</c:when>
	<c:otherwise>
		<spring:message code="componenttype.extendedDetailUrl.tooltip" var="extendedDetailUrlTooltip"/>
    	<spring:message code="componenttype.photoUrl.tooltip" var="photoUrlTooltip"/>        
	</c:otherwise>
</c:choose>
							...
							<fieldset>
								...
								<div class="control-group">
									<form:label path="photoUrl" class="control-label">
										<spring:message code="componenttype.photoUrl" />
									</form:label>
									<div class="controls">
								...
								<div class="control-group">
									<form:label path="extendedDetailUrl" class="control-label">
										<spring:message code="componenttype.extendedDetailUrl" />
									</form:label>
									<div class="controls">
