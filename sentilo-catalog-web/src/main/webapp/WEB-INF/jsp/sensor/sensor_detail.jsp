			...
			<div class="span9">
				...
				<c:if test="${mode == 'detail' }">
					<ul class="nav nav-tabs">
						...
						<li class="${tab4Class}"><a href="#tab4" data-toggle="tab"><spring:message code="additionalInfo.tab.label" /></a></li>
				...
				<c:if test="${mode == 'data' }">
					<ul class="nav nav-tabs">
						...
						<li><a href="${detailSensorLink}?openedTab=4"><spring:message code="additionalInfo.tab.label" /> </a></li>
