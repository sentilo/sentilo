...
<div class="row-fluid">
	...
	<div class="span9">
		...
		<ul class="breadcrumb">
			<li><a href="${providerListURL}"><spring:message code="provider.list.title"/></a> <span class="divider">/</span></li>
		...
		<h1 class="lead">
			${sensor.sensorId}<br/>
			<small><spring:message code="id"/> ${sensor.id}</small>
		</h1>

		<c:if test="${mode == 'detail' }">
			<ul class="nav nav-tabs">
				<li class="${tab1Class}"><a href="#tab1" data-toggle="tab"><spring:message code="sensor.detail.title" /></a></li>
				<li class="${tab2Class}"><a href="#tab2" data-toggle="tab"><spring:message code="sensor.additionalInfo" /></a></li>
