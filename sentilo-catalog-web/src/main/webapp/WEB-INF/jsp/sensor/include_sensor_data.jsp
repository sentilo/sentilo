...
<div class="accordion-group">
	<div class="accordion-heading">
		<a class="accordion-toggle" data-toggle="collapse" data-parent="#lastDataAccordion" href="#lastDataAccordionCollapse">
			<i class="icon-time "></i>
			<spring:message code="sensor.observation.lastData"/>
	...
	<div id="lastDataAccordionCollapse" class="accordion-body collapse in">
		<div class="accordion-inner">
			...
			<div class="row-fluid">
				<div class="span4"><strong><spring:message code="sensor.observation.value" /></strong></div>
				<div class="span8">${sensorLastObservation.value}</div>
			</div>
			<div class="row-fluid">
				<div class="span4"><strong><spring:message code="sensor.observation.timestamp" /></strong></div>
				<div class="span8">
...
<div class="accordion-group">
	<div class="accordion-heading">
		<a class="accordion-toggle" data-toggle="collapse" data-parent="#activityAccordion" href="#activityAccordionCollapse">
			...
			<spring:message code="sensor.observation.activity"/>
			<i class="icon-chevron-down pull-right"></i>
		</a>
	</div>
