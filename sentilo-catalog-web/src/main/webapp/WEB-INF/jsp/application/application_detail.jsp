										...
										<div class="accordion-group">
											...
											<div id="detailAccordionCollapse" class="accordion-body collapse in">
												<div class="accordion-inner">													
													...
													<div class="row-fluid">
														<div class="span4">
															<strong><spring:message code="application.active" /> </strong>
														</div>
														<c:set var="activeChecked" value="${fn:contains(application.active, 'true') ? 'checked' : ''}"/>														
														<div class="span8"><input type="checkbox" ${activeChecked} disabled="disabled" onclick="javascript:return false;"/></div>
													</div>
													<div class="row-fluid">
														<div class="span4">
													...
													<div class="row-fluid">
														<div class="span4">
															<strong><spring:message code="application.contact.name" /> </strong>
														</div>
														<div class="span8">${application.contact.name}</div>
													</div>
													<div class="row-fluid">
														<div class="span4">
