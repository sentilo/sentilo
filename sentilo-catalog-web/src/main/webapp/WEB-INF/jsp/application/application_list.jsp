...
<div class="span12">
	...
	<h1 class="lead">
		<spring:message code="application.list.title" /><br/>
	</h1>

	<form:form method="post" onkeypress="return preventEnterSubmit(event);" modelAttribute="applications" action="${deleteURL}">
