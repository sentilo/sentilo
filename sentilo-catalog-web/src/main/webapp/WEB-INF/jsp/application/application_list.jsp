...
<spring:message code="application.delete.confirmation.message" var="deleteSelectedMessage" />
					...
					<div class="span12">
						...
						<form:form method="post" onkeypress="return preventEnterSubmit(event);" modelAttribute="applications"
							...
							<div class="control-group pull-right">
								<a href="#" onclick='deleteSelected("applications", "${deleteSelectedMessage}");' class="btn btn-danger"> 
