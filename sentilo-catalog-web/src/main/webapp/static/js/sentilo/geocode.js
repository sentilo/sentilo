function Geocode() {
	...
	function reverse(location, result) {
        ...
        jsonGET('https://nominatim.openstreetmap.org/reverse?accept-language='+catalogLocale, queryData, result);
	}
	...
	function search(address, result) {
        ...
        jsonGET('https://nominatim.openstreetmap.org/search?accept-language='+catalogLocale, queryData, result);
	}
}
