...
public class DefaultResourceKeyValidatorImpl implements ResourceKeyValidator {
  ...
  public DefaultResourceKeyValidatorImpl(final Class<? extends CatalogDocument> type,
  ...
  public DefaultResourceKeyValidatorImpl(final MongoRepository<? extends CatalogDocument, String> repository,
  ...
  public void checkIntegrityKey(final String idToCheck) throws DuplicateKeyException {
    if (repository.existsById(idToCheck)) {
