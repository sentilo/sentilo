...
public class ActiveSubscriptionsSynchronizationJob {
  ...
  @SchedulerLock(name = "org.sentilo.web.catalog.admin.scheduler.ActiveSubscriptionsSynchronizationJob.syncActiveSubscriptions")
  public void syncActiveSubscriptions() {
    ...
    activeSubscriptionsService.insertAll(activeSubscriptions);
