...
public class ApplicationServiceImpl extends AbstractBaseServiceImpl<Application> implements ApplicationService {
	...
	@Override
	public String getEntityId(Application entity) {
		return entity.getId();
	}
	...
	public Application create(Application application) {
		...
		//Validamos la unicidad del identificador: no puede existir otra entidad (app o provider) con el mismo identificador.
	 ...
	 */
	public void delete(Collection<Application> applications) {
