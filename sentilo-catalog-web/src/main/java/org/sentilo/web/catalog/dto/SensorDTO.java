...
public class SensorDTO {
  ...
  public SensorDTO(final String sensor, final String sensorType, final String sensorState, final String sensorDescription,
      final String sensorSubState, final String sensorSubstateDesc, final String unit, final String dataType, final String provider) {
    super();
    this.sensor = sensor;
