...
public class ComponentDTO {
  ...
  private ComponentDTO(final Provider provider, final Component component) {
    super();
  ...
  public ComponentDTO(final Provider provider, final Component component, final ComponentType componentType) {
    ...
    photoUrl = ComponentUtils.compilePhotoUrl(component, componentType);
    typeName = componentType != null ? componentType.getName() : typeName;
  }
