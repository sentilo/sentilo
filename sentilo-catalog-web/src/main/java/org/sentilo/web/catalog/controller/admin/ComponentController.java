...
public class ComponentController extends BaseComponentController {
	...
	public @ResponseBody
	List<Component> search(HttpServletRequest request, @RequestParam(required = true) String providerId, Model model) {
		// TODO Este método se utiliza en el mantenimiento de alarmas para seleccionar el sensor de la alarma
	...
	public String addComponents(@PathVariable String id, Model model) {
		List<Component> components = componentService.findAll();
		ComponentComponentsDTO form = new ComponentComponentsDTO(id, components);
	...
	public String assignComponents(@PathVariable String id, @Valid ComponentComponentsDTO componentComponents, BindingResult result, Model model) {
	...
	public String addSensors(@PathVariable String id, Model model) {
		SearchFilter filter = new SearchFilter();
		...
		ComponentSensorsDTO form = new ComponentSensorsDTO(id, sensors);
	...
	public String removeComponents(@PathVariable String id, @Valid ComponentsDTO components, BindingResult result, Model model) {		
	...
	public String addSensors(@PathVariable String id, @Valid ComponentSensorsDTO componentSensors, BindingResult result, Model model) {
	...
	public String removeSensors(@PathVariable String id, @Valid ComponentSensorsDTO sensors, BindingResult result, Model model) {
	...
	@Override
	protected void doBeforeViewResource(String componentId, Model model) {
