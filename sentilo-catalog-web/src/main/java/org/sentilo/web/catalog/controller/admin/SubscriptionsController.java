...
public class SubscriptionsController {
  ...
  public DataTablesDTO getActiveSubscriptions(final HttpServletRequest request, final Model model, final Pageable pageable,
    ...
    final List<Subscription> list = subscriptionService.getActiveSubscriptions(id);

    return toDataTables(pageable, sEcho, list);
  }

  private DataTablesDTO toDataTables(final Pageable pageable, final Integer sEcho, final List<Subscription> list) {
