...
public class ComponentTypesController extends CrudController<ComponentType> {
	...
	@Override
	protected ComponentType buildNewEntity(String id) {
	...
	@Override
	protected List<String> toRow(ComponentType componentType) {
	...
	@Override
	protected void doBeforeCreateResource(ComponentType componentType, Model model) {
	...
	protected void doBeforeDeleteResource(String[] selectedIds, HttpServletRequest request, Model model) {
		for (String componentType : selectedIds) {
