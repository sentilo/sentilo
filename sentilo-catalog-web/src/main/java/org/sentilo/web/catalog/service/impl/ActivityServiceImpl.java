...
public class ActivityServiceImpl extends AbstractBaseCrudServiceImpl<Activity> implements ActivityService {
  ...
  @SchedulerLock(name = "org.sentilo.web.catalog.service.impl.ActivityServiceImpl.deleteOldActivityLogs")
   ...
   * stores the result into the repository lockAtLeastFor and lockAtMostFor lock attributes ensures
   * that this method is only executed once every 5 minutes in any instance
   */
  @Override
  @Scheduled(initialDelay = 10000, fixedRate = 300000)
  @SchedulerLock(name = "org.sentilo.web.catalog.service.impl.ActivityServiceImpl.getAndStorePlatformActivity", lockAtLeastFor = "295s", lockAtMostFor = "5m")
