...
public class StatsDTO {
	...
	public void setEventsPerSecond(String eventsPerSecond) {
	...
	public void setTotalRouterDevices(String totalRouterDevices) {
	...
	public void setTotalOtherDevices(String totalOtherDevices) {
	...
	public void setTotalOrderEvents(String totalOrderEvents) {
	...
	public void setTotalAlarmEvents(String totalAlarmEvents) {
	...
	public void setDailyAverageRate(String dailyAverageRate) {
	...
	public void setTotalProviderAccounts(String totalProviderAccounts) {
	...
	public void setTotalApplicationAccounts(String totalApplicationAccounts) {
