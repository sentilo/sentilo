...
public interface ApplicationService extends CrudService<Application> {
  ...
  boolean isApplicationFromTenant(String applicationId, String tenantId);

  void addApplicationsToSector(final String sectorId, final Map<String, GrantType> applicationsGrants);

  void removeApplicationsFromSector(final String sectorId, final List<String> applicationsIds);
}
