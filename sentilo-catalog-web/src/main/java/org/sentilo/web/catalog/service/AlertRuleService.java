...
public interface AlertRuleService extends CrudService<AlertRule> {
  ...
  List<Sensor> findSensors(final String providerId, final String componentType, final String sensorType);

  ApplyAlertRuleResponse createAlerts(final AlertRule alertRule);
