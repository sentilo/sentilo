...
public abstract class Constants extends SentiloConstants {
  ...
  public static final String MODULE_NAME = "Catalog";
  ...
  public static final String MODEL_GEODETIC_SYSTEM_TYPES = "geodeticSystem";
  ...
  public static final String MODEL_SECTOR = "sector";
  ...
  public static final String VIEW_SECTOR_LIST = "sector/sector_list";
  public static final String VIEW_NEW_SECTOR = "sector/sector_new";
  public static final String VIEW_SECTOR_DETAIL = "sector/sector_detail";
  public static final String VIEW_SECTOR_USERS_NOT_IN_LIST = "sector/users_not_sector_list";
  ...
  public static final String VALIDATION_EMPTY_HTTP_HTTPS_URL = "^$|((http|https).*)";
  ...
  public static final String MENU_SECTOR = "/sectors";
  ...
  public static final String CATALOG_MASTER_APP_ID = "sentilo.master.application.id";
  public static final String PLATFORM_DEFAULT_TTL_KEY = "sentilo.redis.expire.key.seconds";
  ...
  public static final String GEODETIC_SYSTEM_TYPES_KEY = "geodetic-system.types.list";
  public static final String SHOW_HOME_PAGE_KEY = "sentilo.catalog.show_home_page";
  ...
  // Request parameters
  public static final String SECTOR_ID_REQUEST_PARAM = "sectorId";
  public static final String TABLE_NAME_REQUEST_PARAM = "tableName";

  // Sector attribute in model
  public static final String SECTORS_ATTR = "sectors";
  public static final String SECTOR_READ_PERMISSIONS_TYPE = "sectorReadPermission";
  public static final String SECTOR_ADMIN_PERMISSIONS_TYPE = "sectorAdminPermission";

  // Sector grant base message
  public static final String SECTOR_GRANT_MESSAGE = "sector.grant.";
  // User sectors attribute in model
  public static final String USER_SECTORS_LIST = "userSectors";
  // Token regeneration error message
  public static final String TOKEN_REGENERATION_ERROR_TITTLE = "token.regeneration.error.tittle";
  public static final String TOKEN_REGENERATION_ERROR_MESSAGE = "token.regeneration.error.message";
