...
public class NotBlankTenantValidator implements ConstraintValidator<NotBlankTenant, String> {

  @Override
  public void initialize(final NotBlankTenant constraintAnnotation) {
    // Do nothing
  }
