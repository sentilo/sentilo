...
public class PerformanceServiceImpl extends AbstractBaseCrudServiceImpl<Performance> implements PerformanceService {
  ...
  @SchedulerLock(name = "org.sentilo.web.catalog.service.impl.PerformanceServiceImpl.deleteOldPerformanceLogs")
  ...
  @SchedulerLock(name = "org.sentilo.web.catalog.service.impl.PerformanceServiceImpl.getAndStorePlatformPerformance")
