...
public class SearchFilter {
	...
	private Map<String, Object> andParams = new HashMap<String, Object>();
	...
	public SearchFilter(Map<String, String> params, Pageable pageable) {
		this();
		Assert.notNull(params);
		this.params = params;
		this.pageable = pageable;
	...
	public void addAndParam(String name, Object value) {
		this.andParams.put(name, value);
	}
