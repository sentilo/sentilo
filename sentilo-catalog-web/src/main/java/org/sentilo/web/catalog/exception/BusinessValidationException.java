...
public class BusinessValidationException extends CatalogException {
  ...
  public BusinessValidationException(final String errorMessageKey) {
    super(errorMessageKey);
  }

  public BusinessValidationException(final String errorMessageKey, final Object[] errorMessageArgs) {
