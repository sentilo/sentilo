...
public class PlatformMessageParser extends BaseJsonMessageConverter {
  ...
  public PlatformMetricsMessage unmarshallMetricsMessage(final String message) throws MessageNotReadableException {
    return (PlatformMetricsMessage) readInternal(PlatformMetricsMessage.class, message);
  }
