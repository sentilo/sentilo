...
public interface TenantResourceService {
  ...
  void addTenantListVisibilityToProviderResources(String providerId, String tenantId);

  void removeTenantListVisibilityFromProviderResources(final String providerId, final String tenantToRemove);
