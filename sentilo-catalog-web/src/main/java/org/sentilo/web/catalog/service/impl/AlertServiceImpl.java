...
public class AlertServiceImpl extends AbstractBaseCrudServiceImpl<Alert> implements AlertService, ApplicationListener<SensorsStateChangeEvent> {
  ...
  public void deleteOwnAlerts(final String entityOwnerId) {
    ...
    filter.addAndParam("type", AlertType.EXTERNAL.name());
  ...
  @Override
  protected void doAfterDelete(final Alert entity) {
    super.doAfterDelete(entity);
    notifyChange();
  }

  @Override
  protected void doAfterDelete(final Collection<Alert> entities) {
    super.doAfterDelete(entities);
    notifyChange();
  }

  @Override
  protected void doAfterCreate(final Alert entity) {
    super.doAfterCreate(entity);
    notifyChange();
  }

  @Override
  protected void doAfterCreate(final Collection<Alert> entities) {
    super.doAfterCreate(entities);
    notifyChange();
  }

  @Override
  protected void doAfterUpdate(final Alert entity) {
    super.doAfterUpdate(entity);
    notifyChange();
  }

  private void notifyChange() {
    signalService.publishInternalSignal(SignalType.RELOAD_ALERTS, Constants.MODULE_NAME);
  }
