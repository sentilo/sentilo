...
public class ActiveSubscriptionsServiceImpl extends AbstractBaseCrudServiceImpl<ActiveSubscription> implements ActiveSubscriptionsService {
  ...
  @Override
  public MongoRepository<ActiveSubscription, String> getRepository() {
    return activeSubscriptionsRepository;
  }

  @Override
  public String getEntityId(final ActiveSubscription entity) {
    return entity.getId();
  }

  @Override
  protected void doBeforeCreate(final Collection<ActiveSubscription> entities) {
    super.doBeforeCreate(entities);
    activeSubscriptionsRepository.deleteAll();
  }

  @Override
  public void replaceActiveSubscriptions(final List<ActiveSubscription> activeSubscriptions) {
    activeSubscriptionsRepository.deleteAll();
    activeSubscriptionsRepository.saveAll(activeSubscriptions);
  }
