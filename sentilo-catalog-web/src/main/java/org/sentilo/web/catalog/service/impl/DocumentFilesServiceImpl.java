...
public class DocumentFilesServiceImpl extends AbstractBaseCrudServiceImpl<DocumentFile>implements DocumentFilesService {
  ...
  @Override
  public MongoRepository<DocumentFile, String> getRepository() {
    return repository;
  }

  @Override
  public String getEntityId(final DocumentFile entity) {
    return entity.getId();
  }

  @Override
  public boolean checkDuplicateFilename(final String entityId, final String filename) {
    return find(new DocumentFile(entityId, filename)) != null;
  }
