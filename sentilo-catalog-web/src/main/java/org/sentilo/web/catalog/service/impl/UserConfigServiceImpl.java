...
public class UserConfigServiceImpl implements UserConfigService {
  ...
  public void refreshCatalogUserConfigContext() {
    ...
    final String instanceTimeZone = configService.getConfigValue("sentilo.catalog.default.timezone", Constants.DEFAULT_TIME_ZONE);
    final String instanceDateFormatPattern = configService.getConfigValue("sentilo.catalog.default.datePattern", SentiloConstants.TIMESTAMP_PATTERN);
    final Integer instanceChartNumPoints =
        configService.getConfigValue("sentilo.catalog.default.chart.numPoints", Integer.class, Constants.DEFAULT_CHART_POINTS_NUMBER);
