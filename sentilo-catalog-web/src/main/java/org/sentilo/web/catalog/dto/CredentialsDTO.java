...
public class CredentialsDTO {
	...
	public CredentialsDTO(List<CredentialDTO> credential) {
	...
	public void addAll(List<CredentialDTO> credentials) {
		this.credentials.addAll(credentials);
	}

	public void addAllApplications(List<Application> applications) {
		for (Application app : applications) {
			credentials.add(new CredentialDTO(app.getId(), app.getToken()));
		}
	}

	public void addAllProviders(List<Provider> providers) {
		for (Provider provider : providers) {
			credentials.add(new CredentialDTO(provider.getId(), provider.getToken()));
		}
	}

	public void add(CredentialDTO credential) {
