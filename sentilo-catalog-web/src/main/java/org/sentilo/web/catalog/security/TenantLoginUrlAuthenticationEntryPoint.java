...
public class TenantLoginUrlAuthenticationEntryPoint extends LoginUrlAuthenticationEntryPoint {
  ...
  @Override
  protected String determineUrlToUseForThisRequest(final HttpServletRequest request, final HttpServletResponse response,
      final AuthenticationException exception) {
    if (TenantContextHolder.hasContext()) {
      return "/" + TenantUtils.getCurrentTenant() + DEFAULT_LOGIN_FORM_URL;
    } else {
