...
public class SensorEntityKeyValidatorImpl implements EntityKeyValidator {
	...
	public SensorEntityKeyValidatorImpl(SensorService sensorService, DuplicateKeyExceptionBuilder duplicateKeyExceptionBuilder){
	...
	public void checkIntegrityKey(String idToCheck) throws DuplicateKeyException {
		...
		String[] tokens = idToCheck.split(CatalogUtils.escapeRegexCharacter(Constants.DEFAULT_KEY_TOKEN_SPLITTER));
