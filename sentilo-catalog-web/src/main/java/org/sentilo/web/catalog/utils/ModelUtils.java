...
public abstract class ModelUtils {
	...
	public static void addConfirmationMessageTo(Model model, String messageKey) {
	...
	public static void addErrorMessageTo(Model model, String message) {
		model.addAttribute(Constants.MODEL_ERROR_MESSAGE, message);
	}

	public static void addOpenedTabTo(Model model, int index) {
		model.addAttribute(Constants.MODEL_OPENED_TAB, index);
	}

	public static void addActiveMenuTo(Model model, String menu) {
		model.addAttribute(Constants.MODEL_ACTIVE_MENU, menu);
	}

	public static void addUpdateDateTo(Model model) {
