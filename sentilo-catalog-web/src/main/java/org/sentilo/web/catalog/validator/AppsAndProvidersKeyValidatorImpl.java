...
public class AppsAndProvidersKeyValidatorImpl implements EntityKeyValidator, DuplicateKeyExceptionBuilder {
	...
	@Override
	public void checkIntegrityKey(String idToCheck){		
