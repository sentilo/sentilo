...
public class EntityMetadataDTO {
  ...
  public EntityMetadataDTO(final Entity entityObj) {
    entity = entityObj.getId();
    token = entityObj.getToken();
    tenantId = entityObj.getTenantId();
    restHttps = entityObj.isRestHttps();
    apiInputQuota = entityObj.getApiInputQuota();
    apiOutputQuota = entityObj.getApiOutputQuota();
    active = entityObj.isActive();
  }
