 ...
 */
package org.sentilo.agent.alert.test.metrics;
...
import org.sentilo.agent.alert.metrics.AlertAgentMetricsServiceImpl;
...
public class AlertAgentMetricsServiceImplTest {

  static final String AGENT_NAME = "mock-alert-agent";

  @InjectMocks
  private AlertAgentMetricsServiceImpl service;
