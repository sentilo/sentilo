 ...
 */
package org.sentilo.agent.activity.monitor.test;
...
import org.sentilo.agent.activity.monitor.metrics.ActivityMonitorAgentMetricsServiceImpl;
import org.sentilo.agent.common.utils.Constants;
import org.sentilo.common.metrics.SentiloArtifactMetrics;

public class ActivityMonitorAgentMetricsServiceImplTest {

  static final String AGENT_NAME = "mock-activity-monitor-agent";

  @InjectMocks
  private ActivityMonitorAgentMetricsServiceImpl service;
