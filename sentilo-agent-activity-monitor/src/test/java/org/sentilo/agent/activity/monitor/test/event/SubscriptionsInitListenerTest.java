 ...
 */
package org.sentilo.agent.activity.monitor.test.event;
...
import org.sentilo.agent.activity.monitor.event.SubscriptionsInitListener;
...
public class SubscriptionsInitListenerTest {
  ...
  public void onApplicationEvent() {
    ...
    when(subscriptionsDef.getProperty("topics-to-index")).thenReturn("/data/*,/alarm/*");
