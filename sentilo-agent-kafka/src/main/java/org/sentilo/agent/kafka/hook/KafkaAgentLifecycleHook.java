 ...
 */
package org.sentilo.agent.kafka.hook;
...
@Component
public class KafkaAgentLifecycleHook extends AgentLifecycleHook {

  private static final Logger LOGGER = LoggerFactory.getLogger(KafkaAgentLifecycleHook.class);
  ...
  protected void doGracefulShutdown() {
    LOGGER.info("Calling kafka agent doGracefulShutdown method.");

    // ... and flush pending data
    ((KafkaAgentRepositoryImpl) repository).flush();
