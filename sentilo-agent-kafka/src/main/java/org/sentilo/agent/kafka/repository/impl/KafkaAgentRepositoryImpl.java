...
public class KafkaAgentRepositoryImpl implements KafkaAgentRepository {
  ...
  @Value("${sentilo.agent.batch.max.retries:0}")
  ...
  public void init() {
    ...
    LOGGER.info("Initialize {} with the following properties: numMaxRetries {}, numMinWorkers {} and numMaxWorkers {} ",
        this.getClass().getCanonicalName(), numMaxRetries, numMinWorkers, numMaxWorkers);
  }
