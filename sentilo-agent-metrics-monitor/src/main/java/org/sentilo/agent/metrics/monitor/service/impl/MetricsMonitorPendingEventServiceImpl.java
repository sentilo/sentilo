...
import org.sentilo.agent.common.service.impl.AsyncStreamPendingEventServiceImpl;
import org.sentilo.agent.metrics.monitor.service.MetricsMonitorService;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Component;

@Component
public class MetricsMonitorPendingEventServiceImpl extends AsyncStreamPendingEventServiceImpl {
  ...
  protected void processStreamMessage(final String message) {
    metricsMonitorService.process(message);
  }
