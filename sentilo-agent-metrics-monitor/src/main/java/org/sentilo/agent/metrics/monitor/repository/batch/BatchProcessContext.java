...
public class BatchProcessContext {
  ...
  public BatchProcessContext(final List<String> metricsToProcess, final RESTClient restClient, final int numMaxRetries, final String esVersion) {
    super();
    this.metricsToProcess = metricsToProcess;
