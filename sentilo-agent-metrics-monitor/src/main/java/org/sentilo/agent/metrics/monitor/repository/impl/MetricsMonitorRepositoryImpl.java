...
public class MetricsMonitorRepositoryImpl implements MetricsMonitorRepository {
  ...
  public void init() {
    ...
    LOGGER.info(
        "Initialized ActivityMonitorRepositoryImpl with the following properties: esVersion {}, batchSize {},  numMaxRetries {}, numMinWorkers {} and numMaxWorkers {} ",
        esVersion, batchSize, numMaxRetries, numMinWorkers, numMaxWorkers);
  }
  ...
  private String getElasticVersion() {
    ...
    final Map obj = converter.unmarshal(response, Map.class);
