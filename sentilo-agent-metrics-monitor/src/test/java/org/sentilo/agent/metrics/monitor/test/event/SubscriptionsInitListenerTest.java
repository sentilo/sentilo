 ...
 */
package org.sentilo.agent.metrics.monitor.test.event;
...
import org.sentilo.agent.metrics.monitor.metrics.SubscriptionsInitListener;
...
public class SubscriptionsInitListenerTest {
  ...
  public void onApplicationEvent() {
    ...
    when(subscriptionsDef.getProperty("topics-to-index")).thenReturn("/metrics/*,/metrics-2/*");
  ...
  @Test
  public void onApplicationEventWithoutTopicsToIndex() {
    when(subscriptionsDef.isEmpty()).thenReturn(false);
    when(subscriptionsDef.getProperty("topics-to-index")).thenReturn("");
