...
public class BatchProcessResultTest {
  ...
  public void constructor() {
    final int numElementsToProcess = 10;
    when(pendingMetrics.size()).thenReturn(numElementsToProcess);
    result = new BatchProcessResult(numElementsToProcess, pendingMetrics);
