...
@Component
public class AgentConfigServiceImpl extends SentiloModuleConfigServiceImpl {
  ...
  public Map<String, Object> getConfig() {
    ...
    artifactProperties.put(SentiloConstants.SENTILO_AGENT_NAME_ENV, System.getProperty(SentiloConstants.SENTILO_AGENT_NAME_ENV));
