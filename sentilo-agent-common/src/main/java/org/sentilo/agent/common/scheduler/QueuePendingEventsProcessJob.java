...
/**
 * Implementation of {@link PendingEventsProcessJob} related to process agent pending messages from
 * its queue PEL
 */
@Component
public class QueuePendingEventsProcessJob extends PendingEventsProcessJob {
  ...
  protected AsyncPendingEventService getService() {
    return queuePendingEventService;
  }

  @Override
  protected String getRepositoryType() {
    return "Agent queue PEL";
  }
