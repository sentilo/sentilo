...
abstract class AbstractAsyncPendingEventServiceImpl {
  ...
  protected EventMessage unmarshalEvent(final String source) {
    return stringMsgConverter.unmarshal(source, EventMessage.class);
  }
