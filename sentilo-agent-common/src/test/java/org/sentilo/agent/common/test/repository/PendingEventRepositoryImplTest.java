...
public class PendingEventRepositoryImplTest {
  ...
  @Test
  public void pendingQueueSize() {
    final Long queueSize = 200l;
    when(sOps.size("mockagent:pending:events")).thenReturn(queueSize);

    final Long size = repository.pendingQueueSize();
