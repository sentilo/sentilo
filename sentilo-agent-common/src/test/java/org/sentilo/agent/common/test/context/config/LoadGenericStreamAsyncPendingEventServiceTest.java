...
public class LoadGenericStreamAsyncPendingEventServiceTest {
  ...
  @InjectMocks
  private LoadGenericAsyncStreamPendingEventService conditionalService;
  ...
  public void no_loaded_when_location_instance_runs() {
    final String agentName = "METRICS-MONITOR";
    System.setProperty(SentiloConstants.SENTILO_AGENT_NAME_ENV, agentName);
