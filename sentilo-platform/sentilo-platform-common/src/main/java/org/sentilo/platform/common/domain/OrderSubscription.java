...
public class OrderSubscription extends Subscription {
	...
	public OrderSubscription(String sourceEntityId, String providerId, String endpoint) {
		super(sourceEntityId, providerId, endpoint, SubscribeType.ORDER);
	}
	
	public OrderSubscription(String sourceEntityId, String providerId, String sensorId, String endpoint) {
