...
public class NotificationParams {
  ...
  public NotificationParams(final String endpoint, final String secretCallbackKey, final long maxRetries, final long retryDelay) {
    this();
  ...
  public String toString() {
    ...
    sb.append(", retryDelay (minutes): " + retryDelay);
