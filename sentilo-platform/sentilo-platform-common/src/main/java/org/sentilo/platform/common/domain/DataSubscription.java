...
public class DataSubscription extends Subscription{
	...
	public DataSubscription(String entityId, String endpoint, String providerId){
		this(entityId, endpoint, providerId, null);		
	}
	
	public DataSubscription(String entityId, String endpoint, String providerId, String sensorId){
