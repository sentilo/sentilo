...
public class DataSubscription extends Subscription {
  ...
  public DataSubscription(final String entityId, final String providerId, final @Nullable String sensorId,
  ...
  protected Topic buildTopic() {
    if (topic == null) {
      topic = MessagingUtils.buildTopic(SubscribeType.DATA, providerId, sensorId);
    }
    return topic;
  }
