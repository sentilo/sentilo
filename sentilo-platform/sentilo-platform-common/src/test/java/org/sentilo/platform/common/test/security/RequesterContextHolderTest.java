...
public class RequesterContextHolderTest {
  ...
  public void nullContext() {
    ...
    Assert.assertNull(RequesterContextHolder.getContext());
  }

  @Test
  public void getContext() {
    RequesterContextHolder.setContext(context);
    Assert.assertEquals(context, RequesterContextHolder.getContext());
  }

  @Test
  public void getAnonymousContext() {
    RequesterContextHolder.setContext(anonymousContext);
    Assert.assertEquals(anonymousContext, RequesterContextHolder.getContext());
  }
}
