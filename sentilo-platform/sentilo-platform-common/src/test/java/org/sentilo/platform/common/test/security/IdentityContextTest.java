...
public class IdentityContextTest {
  ...
  public void anonymousContext() {
    final IdentityContext context = new AnonymousIdentityContext(entityId);
  ...
  public void buildContext() {
    final IdentityContext context = new IdentityContext(credential);
    ...
    Assert.assertEquals(credential, context.getCredentials());
  }
}
