...
public class EntityCredentialsRepositoryImplTest {
  ...
  public void setUp() {
    ...
    entityMetadata2.setActive(false);
    ...
    repository.loadEntitiesMetadata();
  }
  ...
  @Test
  public void noValidCredential_when_unknown_entity() {
  ...
  @Test
  public void noValidCredential_when_inactive_entity() {
    final boolean validCredential = repository.containsEntityCredential(token2);
    final EntityMetadataMessage entityMetadata = repository.getEntityMetadataFromId(mockEntity2);
