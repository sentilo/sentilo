...
public class NotificationParamsConverterTest {
  ...
  public void unmarshall() {
    ...
    final NotificationParams params = converter.unmarshal(json, NotificationParams.class);
    final NotificationParams params2 = converter.unmarshal(json2, NotificationParams.class);
