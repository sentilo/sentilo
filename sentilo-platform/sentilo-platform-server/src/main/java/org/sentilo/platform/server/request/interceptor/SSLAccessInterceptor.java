...
@Component
public class SSLAccessInterceptor implements SentiloRequestHandlerInterceptor {

  @Override
  public void invoke(final SentiloRequest request) throws ForbiddenAccessException {
    final String schemeAccess = request.extractHeader(HttpHeader.X_FORWARDED_PROTO);
