...
public class AdminHandler extends AbstractHandler {
	...
	private RequestMessageValidator<AdminInputMessage> validator = new AdminValidator();
	...
	public void onGet(SentiloRequest request, SentiloResponse response) throws PlatformException {
		...
		//Este metodo es el punto de entrada a las diferentes operaciones del servicio admin: estadisticas, subscripciones, ...
		...
		AdminInputMessage inputMessage = parser.parseGetRequest(request);		
		...
		if(AdminType.stats.equals(inputMessage.getType())){
			...
			List<Subscription> subscriptions = adminService.getSubscriptions(inputMessage.getEntity());			
	...
	public void setAdminParser(AdminParser parser) {
		this.parser = parser;
	}
