...
public class ErrorConverter extends PlatformJsonMessageConverter {

  public ByteArrayOutputStream writeInternal(final ErrorMessage errorMessage) {
    try {
      return super.writeInternal(errorMessage);
    } catch (final MessageNotWritableException ex) {
      throw buildMarshalJsonException(errorMessage, ex);
    }
  }
}
