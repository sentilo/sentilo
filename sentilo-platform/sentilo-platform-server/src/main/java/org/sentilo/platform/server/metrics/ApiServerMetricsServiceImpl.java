...
public class ApiServerMetricsServiceImpl extends SentiloArtifactMetricsServiceImpl {
  ...
  /*
   * private Map<String, Object> collectRedisPoolMetrics() { final Map<String, Object>
   ...
   * != null && redisPoolLib == null) { final Field poolField =
   * ReflectionUtils.findField(JedisConnectionFactory.class, "pool");
   * ReflectionUtils.makeAccessible(poolField); redisPoolLib = (Pool<Jedis>)
