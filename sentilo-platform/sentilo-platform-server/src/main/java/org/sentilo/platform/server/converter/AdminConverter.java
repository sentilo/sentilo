...
public class AdminConverter extends PlatformJsonMessageConverter {
  ...
  public AdminInputMessage parsePostPutRequest(final SentiloRequest request) throws PlatformException {
    final AdminType type = getAdminType(request);
  ...
  public void writeStatsResponse(final SentiloResponse response, final Statistics stats) throws PlatformException {
    writeInternal(stats, response);
  }

  public void writeMetricsResponse(final SentiloResponse response, final Object metrics) throws PlatformException {
    writeInternal(metrics, response);
  }

  public void writeSubscriptionsResponse(final SentiloResponse response, final List<Subscription> subscriptions) throws PlatformException {
