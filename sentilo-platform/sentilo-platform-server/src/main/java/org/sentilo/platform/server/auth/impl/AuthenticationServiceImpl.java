...
public class AuthenticationServiceImpl implements AuthenticationService{
	 ...
	 */
	public String getIdentity(String credential) throws UnauthorizedException{
	...
	/*
	 * (non-Javadoc)
	 * @see org.sentilo.platform.server.auth.AuthenticationService#addCredential(java.lang.String, java.lang.String)
	 */
	public void addCredential(String identity, String credential) {
	 ...
	 */
	public void removeCredential(String identity) {
		activeCredentials.remove(identity);		
	}
	
	private boolean isValidCredential(String credential) throws UnauthorizedException{
	...
	public void loadActiveCredentials(){
		try {
			...
			CredentialsMessage credentials = catalogService.getCredentials();
			Map<String,String> auxCredentials = new HashMap<String, String>();
			if(credentials!=null && !CollectionUtils.isEmpty(credentials.getCredentials())){
				for(CredentialMessage credential : credentials.getCredentials()){
	...
	private void replaceActiveCredentials(Map<String,String> updateCredentials){
