...
public class OrderParser extends PlatformJsonMessageConverter {
  ...
  public OrderInputMessage parseRequest(final SentiloRequest request) throws PlatformException {
  ...
  public OrderInputMessage parseGetRequest(final SentiloRequest request) throws PlatformException {
  ...
  public void writeResponse(final SentiloRequest request, final SentiloResponse response, final List<Order> orders) throws PlatformException {
