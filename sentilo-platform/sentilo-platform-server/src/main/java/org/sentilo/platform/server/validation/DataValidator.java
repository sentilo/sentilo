...
public class DataValidator extends AbstractRequestMessageValidator<DataInputMessage> {
	...
	@Override
	public void validateRequestMessageOnDelete(DataInputMessage requestMessage) throws MessageValidationException {
		super.validateRequestMessageOnDelete(requestMessage);
	}

	@Override
	public void validateRequestMessageOnPut(DataInputMessage requestMessage) throws MessageValidationException {
	...
	@Override
	public void validateRequestMessageOnGet(DataInputMessage requestMessage) throws MessageValidationException {
