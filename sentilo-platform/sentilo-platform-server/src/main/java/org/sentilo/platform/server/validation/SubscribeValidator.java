...
public class SubscribeValidator extends AbstractRequestMessageValidator<SubscribeInputMessage> {
  ...
  @Override
  public void validateRequestMessageOnDelete(final SubscribeInputMessage requestMessage) throws MessageValidationException {
  ...
  @Override
  public void validateRequestMessageOnGet(final SubscribeInputMessage requestMessage) throws MessageValidationException {
    Assert.notNull(requestMessage);
    super.validateRequestMessageOnPut(requestMessage);
  }
}
