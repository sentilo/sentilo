...
public class CatalogAlertParser extends CatalogParser {

  public CatalogAlertInputMessage parsePostRequest(final SentiloRequest request) throws PlatformException {
  ...
  public CatalogAlertInputMessage parsePutRequest(final SentiloRequest request) throws PlatformException {
    final String entityId = parseEntity(request);
    final CatalogAlertInputMessage inputMessage = readInternal(request);
    inputMessage.setEntityId(entityId);
  ...
  public CatalogAlertInputMessage parseDeleteRequest(final SentiloRequest request) throws PlatformException {
    return parseDeleteRequest(request, false);
  }

  public CatalogAlertInputMessage parseDeleteRequest(final SentiloRequest request, final boolean deleteSimulate) throws PlatformException {
    final String entityId = parseEntity(request);
    final CatalogAlertInputMessage inputMessage =
        (deleteSimulate ? (CatalogAlertInputMessage) readInternal(request) : new CatalogAlertInputMessage());
    inputMessage.setEntityId(entityId);
