...
public class AlarmHandlerTest {
	...
	public void getRequest() throws Exception{							
		...
		AlarmInputMessage message = new AlarmInputMessage("alarm1");
	...
	private List<Alarm> getAlarms(){
		...
		Alarm alarm1 = new Alarm("alarm1", "umbral superado", "sender1", System.currentTimeMillis());
		Alarm alarm2 = new Alarm("alarm1", "no responde", "sender1", System.currentTimeMillis());
