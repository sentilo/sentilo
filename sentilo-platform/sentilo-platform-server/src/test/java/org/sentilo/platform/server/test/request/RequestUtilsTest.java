...
public class RequestUtilsTest {
  ...
  public void splitPath() {
    final String path = "/token1/token2/token3/token4";
  ...
  public void buildPath() {
    final String[] tokens = {"token1", "token2", "token3", "token4"};

    final String path = RequestUtils.buildPath(tokens[0], tokens[1], tokens[2]);
  ...
  public void extractResource() {
    final String path = "/token1/token2/token3/token4";
    final String handlerPath = "/token1/token2";
