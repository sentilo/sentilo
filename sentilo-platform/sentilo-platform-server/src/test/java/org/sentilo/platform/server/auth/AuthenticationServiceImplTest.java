...
public class AuthenticationServiceImplTest extends AbstractBaseTest {
  ...
  public void setUp() {
    ...
    CredentialMessage credential = new CredentialMessage();
    credential.setToken(token);
    credential.setEntity("periko");

    List<CredentialMessage> credentials = new ArrayList<CredentialMessage>();
    credentials.add(credential);

    CredentialsMessage message = new CredentialsMessage();
  ...
  public class AuthenticationRunnable implements Runnable {
    ...
    public AuthenticationRunnable(AuthenticationServiceImpl authenticationService) {
