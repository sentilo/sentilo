 ...
 */
package org.sentilo.platform.server.auth;
...
public class AuthorizationServiceImplTest extends AbstractBaseTest {
  ...
  private PermissionsMessage getPermissions() {
    ...
    PermissionMessage permission1 = new PermissionMessage(PROVIDER1, APPCLIENT1, PermissionType.READ.name());
    PermissionMessage permission2 = new PermissionMessage(PROVIDER1, APPCLIENT2, PermissionType.WRITE.name());
    PermissionMessage permission3 = new PermissionMessage(PROVIDER1, APPCLIENT3, PermissionType.ADMIN.name());
