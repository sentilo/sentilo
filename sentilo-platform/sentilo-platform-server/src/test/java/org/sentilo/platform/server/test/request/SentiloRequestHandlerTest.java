...
public class SentiloRequestHandlerTest {
  ...
  public void handler() throws Exception {
    ...
    when(sentiloConfigProperties.get(SentiloConstants.SENTILO_VERSION_KEY)).thenReturn("sentilo-test");
    ...
    verify(httpResponse).setHeader(HttpHeader.X_SENTILO_VERSION.toString(), "sentilo-test");
  }
