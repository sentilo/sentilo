...
public class OrderParserTest {
	...
	public void parsePutRequestTest() throws Exception {				
		...
		String order = "stop restart";
		
		String json = "{\"order\":\"stop restart\"}";
		...
		OrderInputMessage message = parser.parseRequest(sentiloRequest);
	...
	public void parseGetRequestWithoutFilter() throws Exception{
		...
		OrderInputMessage message = parser.parseGetRequest(sentiloRequest);
	...
	public void parseSensorOrdersWriteResponse() throws Exception {				
		...
		String expected = "{\"orders\":[{\"order\":\"stop\",\"timestamp\":\"21/02/2013T17:49:24\",\"sender\":\"sender1\"},{\"order\":\"start\",\"timestamp\":\"21/02/2013T17:49:30\",\"sender\":\"sender1\"}]}";		
	...
	public void parseProviderWriteResponse() throws Exception {				
		...
		ByteArrayOutputStream baos = new ByteArrayOutputStream();
		((ByteArrayEntity)response.getHttpResponse().getEntity()).writeTo(baos);
		String expected = "{\"sensors\":[{\"sensor\":\"sensor1\",\"orders\":[{\"order\":\"stop\",\"timestamp\":\"21/02/2013T17:49:24\",\"sender\":\"sender1\"}]},{\"sensor\":\"sensor2\",\"orders\":[{\"order\":\"stop\",\"timestamp\":\"21/02/2013T17:49:30\",\"sender\":\"sender1\"},{\"order\":\"start\",\"timestamp\":\"21/02/2013T17:49:30\",\"sender\":\"sender1\"}]}]}";
		assertEquals(expected, baos.toString());		
	}
	...
	private List<Order> getSensorOrders(){
		...
		Order order1 = new Order("prov1", "sensor1", "stop", "sender1", DateUtils.toMillis("21/02/2013T17:49:24"));
		Order order2 = new Order("prov1", "sensor1", "start", "sender1", DateUtils.toMillis("21/02/2013T17:49:30"));
		orders.add(order1);
		orders.add(order2);
	...
	private List<Order> getProviderOrders(){
		List<Order> orders = new ArrayList<Order>();
		Order order1 = new Order("prov1", "sensor1", "stop", "sender1", DateUtils.toMillis("21/02/2013T17:49:24"));
		Order order2 = new Order("prov1", "sensor2", "stop", "sender1", DateUtils.toMillis("21/02/2013T17:49:30"));
		Order order3 = new Order("prov1", "sensor2", "start", "sender1", DateUtils.toMillis("21/02/2013T17:49:30"));
		orders.add(order1);
		orders.add(order2);
		orders.add(order3);
		return orders;
