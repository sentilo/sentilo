...
public class DataParserTest {
  ...
  public void parseSensorWriteResponse() throws Exception {
    ...
    final String expected =
        "{\"observations\":[{\"value\":\"1\",\"timestamp\":\"21/02/2013T17:49:24\"},{\"value\":\"10\",\"timestamp\":\"21/02/2013T17:49:30\"}]}";
  ...
  public void parseProviderWriteResponse() throws Exception {
    ...
    ((ByteArrayEntity) response.getHttpResponse().getEntity()).writeTo(baos);
    final String expected =
        "{\"sensors\":[{\"sensor\":\"sensor1\",\"observations\":[{\"value\":\"1\",\"timestamp\":\"21/02/2013T17:49:24\"}]},{\"sensor\":\"sensor2\",\"observations\":[{\"value\":\"10\",\"timestamp\":\"21/02/2013T17:49:30\"},{\"value\":\"5\",\"timestamp\":\"20/02/2013T17:49:30\"}]}]}";
    assertEquals(expected, baos.toString());
  }
