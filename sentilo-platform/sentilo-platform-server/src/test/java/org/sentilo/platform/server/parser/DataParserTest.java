...
public class DataParserTest {
  ...
  public void parsePutObservationsList() throws Exception {
    final String json = "{\"observations\":[{\"value\":\"10.1\"}, {\"value\":\"11.2\", \"timestamp\": \"17/09/2012T12:34:45\"}, {\"value\":\"12.3\"}]}";
  ...
  public void parsePutSensorsList() throws Exception {
    final String json = "{\"sensors\":[{\"sensor\":\"sensor1\",\"observations\":[{\"value\":\"10.1\"},{\"value\":\"11.2\",\"timestamp\":\"17/09/2012T12:34:45\"},{\"value\":\"12.3\"}]},{\"sensor\":\"sensor2\",\"observations\":[{\"value\":\"10.1\"},{\"value\":\"11.2\",\"timestamp\":\"17/09/2012T12:34:45\"},{\"value\":\"12.3\"}]}]}";
  ...
  public void parseProviderWriteResponse() throws Exception {
    ...
    final ByteArrayOutputStream baos = new ByteArrayOutputStream();
    ((ByteArrayEntity) response.getHttpResponse().getEntity()).writeTo(baos);
    final String expected = "{\"sensors\":[{\"sensor\":\"sensor1\",\"observations\":[{\"value\":\"1\",\"timestamp\":\"21/02/2013T17:49:24\"}]},{\"sensor\":\"sensor2\",\"observations\":[{\"value\":\"10\",\"timestamp\":\"21/02/2013T17:49:30\"},{\"value\":\"5\",\"timestamp\":\"20/02/2013T17:49:30\"}]}]}";
    assertEquals(expected, baos.toString());
  }
