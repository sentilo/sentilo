...
public class CounterServiceImpl extends AbstractMetricsServiceImpl implements CounterService {
  ...
  private PlatformActivity getPlatformActivity(final String counterKey) {
    ...
    final String tenant = isMaster ? null : counterKey.split(SentiloConstants.REDIS_KEY_TOKEN)[2];
  ...
  private String buildHashKey(final CounterContext context, final MetricKeyType countKeyType) {
    final StringBuilder sb = new StringBuilder(MonitorConstants.COUNTERS_PREFIX + SentiloConstants.REDIS_KEY_TOKEN);
    switch (countKeyType) {
      case master:
      ...
      case entity:
        ...
        sb.append(SentiloConstants.REDIS_KEY_TOKEN);
