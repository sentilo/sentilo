...
public class QueryFilterParamsUtils {

	public static Long getTo(PlatformSearchInputMessage message){
	...
	public static Long getFrom(PlatformSearchInputMessage message){
	...
	public static Integer getLimit(PlatformSearchInputMessage message){
		...
		if(!message.hasQueryFilters() || message.getQueryFilters().getLimit() == null){
			...
			return (message.getQueryFilters().getLimit() > SentiloConstants.NUM_MAXIM_ELEMENTS
						?SentiloConstants.NUM_MAXIM_ELEMENTS: message.getQueryFilters().getLimit());
		}		
	}
}
