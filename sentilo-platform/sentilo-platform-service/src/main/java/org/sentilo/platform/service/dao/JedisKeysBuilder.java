...
public class JedisKeysBuilder {
  ...
  public String getAlarmMessagesKey(final Long aid) {
    return "aid:" + aid + ":messages";
  }

  public String getMessageKey(final Long amid) {
    return "amid:" + amid;
  }
  ...
  public String getAlarmKey(final Long aid) {
    return "aid:" + aid;
  }

  public String getReverseAlarmKey(final String alarmId) {
