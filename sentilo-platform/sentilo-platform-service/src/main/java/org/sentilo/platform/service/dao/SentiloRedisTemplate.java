...
public class SentiloRedisTemplate {
  ...
  public Boolean del(final String key) {
    // Unlink command has a better performance that del from a point of view of response
    // because performs the actual memory reclaiming in a different thread, so it is not blocking.
