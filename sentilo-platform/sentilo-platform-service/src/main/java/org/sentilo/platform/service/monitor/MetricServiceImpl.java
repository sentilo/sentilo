...
public class MetricServiceImpl extends AbstractMetricsServiceImpl implements MetricService {
  ...
  @SchedulerLock(name = "org.sentilo.platform.service.monitor.MetricServiceImpl.computeGlobalPerformance")
  public void computeGlobalPerformance() {
    // Compute the current performance for both the master platform and for each tenant registered
    // into it.
