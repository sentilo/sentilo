...
/**
 * Utility methods for build EventMessage instances based on input messages .
 */
public abstract class PublishMessageUtils extends MessagingUtils {
  ...
  public static EventMessage buildEvent(final AlarmInputMessage message, final Topic topic) {
  ...
  public static EventMessage buildEvent(final OrderInputMessage message, final Topic topic) {
    final Long timestamp = System.currentTimeMillis();
  ...
  public static EventMessage buildEvent(final Observation message, final Topic topic) {
    final EventMessage event = new EventMessage();
  ...
  public static String buildAndMarshalEvent(final AlarmInputMessage message, final Topic topic) {
    final EventMessage eventMessage = buildEvent(message, topic);
    return marshal(eventMessage);
  }
