...
public class InternalAlarmServiceImpl implements InternalAlarmService {
  ...
  @Override
  public Optional<String> publishGhostSensorAlarm(final Observation data) {
    final String ghostSensorKey = data.getProvider() + "." + data.getSensor();
    String sMessage = null;
    if (ghostSensors.get(ghostSensorKey) == null) {
      final Topic topic = MessagingUtils.buildTopic(SubscribeType.ALARM, data.getProvider(), data.getSensor());
      ...
      sMessage = PublishMessageUtils.buildAndMarshalEvent(aim, topic);
    ...
    return Optional.ofNullable(sMessage);
  }

  @Override
  public Optional<String> publishInboundRateLimiterAlarm(final String entity, final QuotaContext quotaContext) {
    String sMessage = null;
    if (inboundOverQuotaEntities.get(entity) == null) {
      final Topic topic = MessagingUtils.buildTopic(SubscribeType.ALARM, entity);
  ...
  @Override
  public Optional<String> publishOutboundRateLimiterAlarm(final String entity, final QuotaContext quotaContext) {
    String sMessage = null;
    if (outboundOverQuotaEntities.get(entity) == null) {
      ...
      try {
        ...
        // null and need to be generated before invoke method.
