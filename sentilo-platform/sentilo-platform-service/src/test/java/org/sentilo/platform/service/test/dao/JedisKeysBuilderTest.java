...
public class JedisKeysBuilderTest {
  ...
  @InjectMocks
  private JedisKeysBuilder keysBuilder;
  ...
  @Test
  public void getAlarmMessagesKey() {
    Assert.assertEquals("aid:" + aid + ":messages", keysBuilder.getAlarmMessagesKey(new Long(aid)));
  }

  @Test
  public void getMessageKey() {
    Assert.assertEquals("amid:" + amid, keysBuilder.getMessageKey(new Long(amid)));
  }
  ...
  public void getAlarmKey() {
    Assert.assertEquals("aid:" + aid, keysBuilder.getAlarmKey(new Long(aid)));
  }

  @Test
  public void getReverseAlarmKey() {
    Assert.assertEquals("alarm:" + alarmId + ":aid", keysBuilder.getReverseAlarmKey(alarmId));
  }
