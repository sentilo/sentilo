...
public class OrderServiceImplTest {
	...
	public void setOrder(){
		...
		String channel = ChannelUtils.buildTopic(PubSubChannelPrefix.order, message.getProviderId(), message.getSensorId()).getTopic();
