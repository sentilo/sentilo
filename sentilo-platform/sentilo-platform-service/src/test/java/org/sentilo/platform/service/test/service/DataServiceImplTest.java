...
public class DataServiceImplTest {
	...
	@Mock private DataInputMessage inputMessage;
	...
	public void setObservations(){
		...
		List<Observation> observations = buildObservations();
		...
		Topic topic = ChannelUtils.buildTopic(PubSubChannelPrefix.data, provider, sensor);	
