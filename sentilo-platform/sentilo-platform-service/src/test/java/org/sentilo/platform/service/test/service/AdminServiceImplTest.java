...
public class AdminServiceImplTest extends AbstractBaseTest {
  ...
  public void deleteProviders() {
    ...
    verify(publishService).publishInternalSignal(SignalType.DELETE_ENTITIES);
  }
  ...
  public void deleteSensors() {
    ...
    verify(publishService).publishInternalSignal(SignalType.DELETE_SENSORS);
  }
  ...
  public void deleteAlerts() {
    ...
    verify(publishService).publishInternalSignal(SignalType.DELETE_ALERTS);
  }
