...
public class CatalogResponseMessagesConverterTest {
  ...
  public void parsePermissions() throws Exception {
    ...
    final PermissionsMessage message = converter.unmarshal(json, PermissionsMessage.class);
  ...
  public void parseEntitiesMetadata() throws Exception {
    ...
    final EntitiesMetadataMessage message = converter.unmarshal(json, EntitiesMetadataMessage.class);
  ...
  public void parseCatalogResponse() throws Exception {
    ...
    final CatalogResponseMessage message = converter.unmarshal(json, CatalogResponseMessage.class);
