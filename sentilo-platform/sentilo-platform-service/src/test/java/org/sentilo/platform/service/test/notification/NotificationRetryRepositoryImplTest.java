...
public class NotificationRetryRepositoryImplTest {
  ...
  public void getEventsToRetry() {
    ...
    when(zSetOperations.popMin(eq("push:pending:events"), eq(limit)))
        .thenReturn(new HashSet<TypedTuple<String>>(Arrays.asList(new DefaultTypedTuple<String>(retryEvent, score))));
