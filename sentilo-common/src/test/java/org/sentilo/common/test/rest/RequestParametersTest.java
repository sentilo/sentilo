...
public class RequestParametersTest {
	...
	public void buildEmptyRequestParameters(){
		RequestParameters request = RequestParameters.build(null, null, null);
	...
	public void buildBasicRequestParameters(){
		RequestParameters request = RequestParameters.build(new Date(), new Date(), new Integer(SentiloConstants.NUM_MAXIM_ELEMENTS));
	...
	public void buildDeleteRequestParameters(){
		RequestParameters request = RequestParameters.buildDelete();		
