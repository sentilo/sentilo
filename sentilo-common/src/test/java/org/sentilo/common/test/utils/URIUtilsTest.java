...
public class URIUtilsTest {
	...
	public void uriWithoutParams() {
		String uri = URIUtils.getURI(HOST, PATH);
		assertEquals("http://www.example.com/service/endpoint", uri);
	}
	
	@Test
	public void uriWithHostAndPathWithSlash(){
		String uri = URIUtils.getURI(HOST_ENDS_WITH_SLASH, PATH);
		assertEquals("http://www.example.com/service/endpoint", uri);
	}
	
	@Test
	public void uriWithoutHostAndPathWithSlash(){
		String uri = URIUtils.getURI(HOST, PATH_NOT_STARTS_WITH_SLASH);
		assertEquals("http://www.example.com/service/endpoint", uri);
	}
	...
	public void uriWithParams() {
		...
		String uri = URIUtils.getURI(HOST, PATH, parameters);
