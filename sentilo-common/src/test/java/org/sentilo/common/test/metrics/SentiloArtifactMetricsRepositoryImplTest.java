...
public class SentiloArtifactMetricsRepositoryImplTest {
  ...
  @Mock
  private StreamOperations<String, Object, Object> strOps;

  @InjectMocks
  private SentiloArtifactMetricsRepositoryImpl repository;

  private final MockMetricsServiceImpl metricsService = new MockMetricsServiceImpl();
  ...
  public void saveArtifactConfig() {
    ...
    when(redisTemplate.opsForStream()).thenReturn(strOps);
