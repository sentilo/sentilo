...
public class SentiloUtilsTest {
  ...
  public void getElementAt() {
    ...
    assertNull(SentiloUtils.getElementAt(emptyArray, 1));
    assertNull(SentiloUtils.getElementAt(noEmptyArray, 3));
    assertEquals("c", SentiloUtils.getElementAt(noEmptyArray, 2));
  ...
  public void isValidLocationFormat() {
    ...
    final String location6 = "324.234 4325.2345";
    final String location7 = "324.234 4325.2345, 1.123456 4.435678";
    final String location8 = "-89.123456 120.345678";
    final String location9 = "-109.123456 176.25678";
    ...
    assertFalse(SentiloUtils.isValidLocationFormat(location6));
    assertFalse(SentiloUtils.isValidLocationFormat(location7));
    assertTrue(SentiloUtils.isValidLocationFormat(location8));
    assertFalse(SentiloUtils.isValidLocationFormat(location9));
