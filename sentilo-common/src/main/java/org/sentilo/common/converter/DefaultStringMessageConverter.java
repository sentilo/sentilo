...
public class DefaultStringMessageConverter extends BaseJsonMessageConverter implements StringMessageConverter {
  ...
  @Override
  public String marshal(final Object message) throws MessageNotWritableException {
    return writeInternalAndReturnString(message);
  }

  @SuppressWarnings("unchecked")
  @Override
  public <T> T unmarshal(final String body, final Class<? extends T> clazz) throws MessageNotWritableException {
    return (T) readInternal(clazz, body);
  }
}
