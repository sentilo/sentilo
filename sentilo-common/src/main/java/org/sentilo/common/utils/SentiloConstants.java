...
public abstract class SentiloConstants {
  ...
  public static final String SENTILO_VERSION_KEY = "sentilo.version";

  public static final String SENTILO_AGENT_NAME_ENV = "sentilo.agent.name";
  public static final String SENTILO_NODE_AGENT_NAME_ENV = "sentilo.node.agent.name";
  ...
  public static final String CHANNEL_PATTERN_SUFFIX = "*";
  public static final String REDIS_CHANNEL_TOKEN = SLASH;
  ...
  public static final String INTERNAL_SIGNALS_TOPIC = "__sentilo_internal_signals__";
