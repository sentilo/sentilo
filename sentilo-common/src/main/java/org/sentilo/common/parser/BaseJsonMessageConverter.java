...
public class BaseJsonMessageConverter {
	...
	protected ByteArrayOutputStream writeInternal(Object o) throws MessageNotWritableException {
		ByteArrayOutputStream out = new ByteArrayOutputStream();
		try {
			JsonGenerator jsonGenerator = this.objectMapper.getJsonFactory().createJsonGenerator(out, DEFAULT_ENCODING);
	...
	protected String writeInternalAndReturnString(Object o) throws MessageNotWritableException {		
		ByteArrayOutputStream out = writeInternal(o);			
		return out.toString();		
	}
	 ...
	 */
	protected Object readInternal(Class<?> clazz, String json) throws MessageNotReadableException {
