...
public class NotificationMessageConverter extends BaseJsonMessageConverter {
	...
	public String marshall(NotificationMessage message) throws MessageNotWritableException{
		return writeInternalAndReturnString(message);
	}
	
	public NotificationMessage unmarshall(String body) throws MessageNotWritableException{
