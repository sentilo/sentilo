...
public class SentiloArtifactsMetricsMessage {
  ...
  public void addArtifactMetrics(final SentiloArtifactMetrics artifactMetrics) {
    if (artifactsMetrics == null) {
      artifactsMetrics = new ArrayList<SentiloArtifactMetrics>();
    }
    artifactsMetrics.add(artifactMetrics);
  }

  public List<SentiloArtifactMetrics> getArtifactsMetrics() {
    return artifactsMetrics == null ? new ArrayList<SentiloArtifactMetrics>() : artifactsMetrics;
  }
