...
public class SensorMessageLocation implements CatalogElement, Comparable<SensorMessageLocation> {
  ...
  public SensorMessageLocation(final EventMessage eventMessage) {
    this();
    provider = eventMessage.getProvider();
    sensor = eventMessage.getSensor();
    location = eventMessage.getLocation();
    fromTsTime = eventMessage.getTime();
  }
  ...
  public boolean equals(final Object obj) {
    ...
    final SensorMessageLocation other = (SensorMessageLocation) obj;
  ...
  @Override
  public int compareTo(final SensorMessageLocation other) {
    return fromTsTime.compareTo(other.fromTsTime);
  }

  @Override
  public String toString() {
    return "SensorMessageLocation [sensor=" + sensor + ", provider=" + provider + ", location=" + location + ", fromTsTime=" + fromTsTime + "]";
  }
