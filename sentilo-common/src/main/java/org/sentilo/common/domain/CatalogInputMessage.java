...
public class CatalogInputMessage implements PlatformInputMessage {
  ...
  @JsonInclude(value = Include.NON_EMPTY)
  private List<SensorMessageLocation> locations;
  ...
  public List<SensorMessageLocation> getLocations() {
    return locations;
  }

  public void setLocations(final List<SensorMessageLocation> locations) {
