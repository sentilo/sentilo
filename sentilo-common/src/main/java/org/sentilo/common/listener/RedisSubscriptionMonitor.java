...
public abstract class RedisSubscriptionMonitor implements SmartLifecycle, MessageListener {
  ...
  private final ErrorHandler redisMonitorErrorHandler = new RedisLoggingErrorHandler();
  ...
  private static class RedisLoggingErrorHandler implements ErrorHandler {
    ...
    public void handleError(final Throwable throwable) {
      LOGGER.warn("An error has been raised while attempting to communicate with Redis {}", throwable.getMessage(), throwable);
    }
