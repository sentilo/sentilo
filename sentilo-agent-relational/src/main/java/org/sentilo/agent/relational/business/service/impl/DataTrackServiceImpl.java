...
public class DataTrackServiceImpl implements DataTrackService{
	...
	/*
	 * (non-Javadoc)
	 * @see org.sentilo.agent.relational.business.service.DataTrackService#save(org.sentilo.agent.relational.common.domain.Order)
	 */
	@Transactional
	...
	/*
	 * (non-Javadoc)
	 * @see org.sentilo.agent.relational.business.service.DataTrackService#save(org.sentilo.agent.relational.common.domain.Alarm)
	 */
	@Transactional
	...
	/*
	 * (non-Javadoc)
	 * @see org.sentilo.agent.relational.business.service.DataTrackService#save(org.sentilo.agent.relational.common.domain.Observation)
	 */
	@Transactional
	...
	public void setAgentRelationalDao(AgentRelationalRepository agentRelationalDao) {
