...
public class BatchProcessContextTest extends AbstractBaseTest {
  ...
  @Mock
  private List<EventMessage> dataToPersist;
  @Mock
  ...
  private final Integer numMaxRetries = Integer.MAX_VALUE;
  ...
  public void newContext() {
    final BatchProcessContext context =
        new BatchProcessContext(dataToPersist, jdbcTemplate, transactionManager, numMaxRetries, tablesPrefix, callback);
