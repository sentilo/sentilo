...
public class MessageListenerImplTest {
	...
	@Mock private DataTrackService dataTrackService;
	...
	public void onDataMessage(){
		...
		String value =	"09/09/2013T15:55:17#@#43";
		String pattern = Constants.DATA;
	...
	public void onOrderMessage(){		
		...
		String channel = "order:provider1:sensor1";
		String value = "09/09/2013T15:55:17#@#test order message";
		String pattern = Constants.ORDER;
	...
	public void onAlarmMessage(){	
		...
		String channel = "alarm:alarm1";
		String value =	"09/09/2013T15:55:17#@#test alarm message";
		String pattern = Constants.ALARM;
