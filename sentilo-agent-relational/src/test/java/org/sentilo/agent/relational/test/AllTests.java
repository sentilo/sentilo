...
@Suite.SuiteClasses({ 
  AgentRelationalDaoImplTest.class,
  DataTrackServiceImplTest.class,
  MessageListenerImplTest.class,
  SentiloRoutingDataSourceTest.class,
  MonitorMessageListenerImplTest.class,
  ConnectionMonitorListenerTest.class,
  UtilsTest.class}
)
