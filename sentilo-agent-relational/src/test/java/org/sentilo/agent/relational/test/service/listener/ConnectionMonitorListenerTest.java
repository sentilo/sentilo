...
public class ConnectionMonitorListenerTest {
  ...
  // Como esta clase tiene metodos finales que queremos validar, usamos la instancia real en vez del
  // mock
  ...
  public void start() throws Exception {
    final Field initialized = RedisMessageListenerContainer.class.getDeclaredField("initialized");
