...
public class HistorianRepositoryImpl implements HistorianRepository {
  ...
  @Value("${sentilo.agent.batch.workers.size:5}")
  ...
  public void init() {
    ...
    LOGGER.info(
        "Initialized HistorianRepositoryImpl with the following properties: batchSize {},  numMaxRetries {},  numMinWorkers {} and numMaxWorkers {} ",
        batchSize, numMaxRetries, numMinWorkers, numMaxWorkers);
