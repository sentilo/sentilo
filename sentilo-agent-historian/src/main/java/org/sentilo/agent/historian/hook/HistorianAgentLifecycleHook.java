 ...
 */
package org.sentilo.agent.historian.hook;
...
@Component
public class HistorianAgentLifecycleHook extends AgentLifecycleHook {

  private static final Logger LOGGER = LoggerFactory.getLogger(HistorianAgentLifecycleHook.class);
  ...
  protected void doGracefulShutdown() {
    ...
    ((HistorianRepositoryImpl) repository).flush();
