...
public class OpenTSDBDataPointMarshaller {
  ...
  private static Map<String, String> createTags(final EventMessage event) {
    ...
    putTag(tags, Tags.type.name(), event.getType());
    putTag(tags, Tags.sensor.name(), event.getSensor());
    putTag(tags, Tags.provider.name(), event.getProvider());
    putTag(tags, Tags.component.name(), event.getComponent());
    putTag(tags, Tags.alertType.name(), event.getAlertType());
    putTag(tags, Tags.sensorType.name(), event.getSensorType());
    putTag(tags, Tags.publisher.name(), event.getPublisher());
    putTag(tags, Tags.tenant.name(), event.getTenant());
    putTag(tags, Tags.publisherTenant.name(), event.getPublisherTenant());
