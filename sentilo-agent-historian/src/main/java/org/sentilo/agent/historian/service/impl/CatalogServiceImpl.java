...
public class CatalogServiceImpl implements CatalogService {
  ...
  private final LRUCache<String, String> sensorTypesCache = new LRUCacheImpl<String, String>(50000);
  private final LRUCache<String, CatalogAdditionalFields> alertAdditionalFieldsCache = new LRUCacheImpl<String, CatalogAdditionalFields>(1000);
  ...
  public String getSensorType(final String provider, final String sensor) {
    ...
    if (sensorTypesCache.get(cacheKey) == null) {
      ...
      final CatalogAdditionalFields f = mongoOperations.findOne(query, CatalogAdditionalFields.class, "sensor");
      if (f != null) {
