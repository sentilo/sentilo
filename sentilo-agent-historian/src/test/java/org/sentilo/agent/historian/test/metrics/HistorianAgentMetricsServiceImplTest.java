 ...
 */
package org.sentilo.agent.historian.test.metrics;
...
import org.sentilo.agent.historian.metrics.HistorianAgentMetricsServiceImpl;
import org.sentilo.common.metrics.SentiloArtifactMetrics;

public class HistorianAgentMetricsServiceImplTest {

  static final String AGENT_NAME = "mock-historian-agent";

  @InjectMocks
  private HistorianAgentMetricsServiceImpl service;
